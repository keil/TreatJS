...
var RegExpSetup = _wrap_(function () {
        regExpBenchmark = new RegExpBenchmark();
        RegExpRun();
    });
var RegExpRun = _wrap_(function () {
        regExpBenchmark.run();
    });
var RegExpTearDown = _wrap_(function () {
        regExpBenchmark = null;
    });
var computeInputVariants = _wrap_(function (str, n) {
        var variants = [str];
        for (var i = 1; i < n; i++) {
...
var RegExpBenchmark = _wrap_(function () {
        var Exec = _wrap_(function (re, string) {
                var sum = 0;
                re.lastIndex = 0;
        ...
        var runBlock10 = _wrap_(function () {
                var sum = 0;
                for (var i = 0; i < 3; i++) {
        ...
        var runBlock11 = _wrap_(function () {
                var sum = 0;
                for (var i = 0; i < 2; i++) {
