var EarleyBoyer = new BenchmarkSuite('EarleyBoyer', [666463], [
        new Benchmark('Earley', true, false, 2500, _wrap_(function () {
            BgL_earleyzd2benchmarkzd2();
        })),
        new Benchmark('Boyer', true, false, 200, _wrap_(function () {
...
function sc_raise(obj) {
    return _wrap_(function (obj) {
        throw obj;
    }).bind(this)(obj);
}
function sc_withHandlerLambda(handler, body) {
    return _wrap_(function (handler, body) {
        try {
            return body();
        } catch (e) {
    ...
    }).bind(this)(handler, body);
}
var sc_properties = new Object();
function sc_putpropBang(sym, key, val) {
    return _wrap_(function (sym, key, val) {
        ...
        ht[key] = val;
    }).bind(this)(sym, key, val);
}
function sc_getprop(sym, key) {
    return _wrap_(function (sym, key) {
        var ht = sc_properties[sym];
        if (ht) {
            if (key in ht)
                return ht[key];
...
function sc_any2String(o) {
    return _wrap_(function (o) {
        return jsstring2string(sc_toDisplayString(o));
    }).bind(this)(o);
}
function sc_isEqv(o1, o2) {
    return _wrap_(function (o1, o2) {
        return o1 === o2;
    }).bind(this)(o1, o2);
}
...
function sc_number2jsstring(x, radix) {
    return _wrap_(function (x, radix) {
        if (radix)
...
function sc_jsstring2number(s, radix) {
    return _wrap_(function (s, radix) {
        if (s === '')
            return false;
        if (radix) {
...
function sc_Pair(car, cdr) {
    return _wrap_(function (car, cdr) {
        this.car = car;
        this.cdr = cdr;
    }).bind(this)(car, cdr);
}
sc_Pair.prototype.toString = _wrap_(function () {
    return sc_toDisplayString(this);
});
sc_Pair.prototype.sc_toWriteOrDisplayString = _wrap_(function (writeOrDisplay) {
    var current = this;
    var res = '(';
    while (true) {
...
sc_Pair.prototype.sc_toDisplayString = _wrap_(function () {
    return this.sc_toWriteOrDisplayString(sc_toDisplayString);
});
sc_Pair.prototype.sc_toWriteString = _wrap_(function () {
    return this.sc_toWriteOrDisplayString(sc_toWriteString);
});
function sc_isPair(p) {
    return _wrap_(function (p) {
        return p instanceof sc_Pair;
    }).bind(this)(p);
}
function sc_isPairEqual(p1, p2, comp) {
    return _wrap_(function (p1, p2, comp) {
        return comp(p1.car, p2.car) && comp(p1.cdr, p2.cdr);
    }).bind(this)(p1, p2, comp);
}
...
function sc_iota(num, init) {
    return _wrap_(function (num, init) {
        var res = null;
        if (!init)
            init = 0;
...
function sc_makeList(nbEls, fill) {
    return _wrap_(function (nbEls, fill) {
        var res = null;
        for (var i = 0; i < nbEls; i++)
            res = new sc_Pair(fill, res);
        return res;
    }).bind(this)(nbEls, fill);
}
...
function sc_isCharStringEqual(cs1, cs2) {
    return _wrap_(function (cs1, cs2) {
...
sc_Char.prototype.toString = _wrap_(function () {
    return this.val;
});
sc_Char.prototype.sc_toWriteString = _wrap_(function () {
...
var sc_Vector = Array;
sc_Vector.prototype.sc_toWriteOrDisplayString = _wrap_(function (writeOrDisplay) {
    if (this.length === 0)
        return '#()';
...
sc_Vector.prototype.sc_toDisplayString = _wrap_(function () {
    return this.sc_toWriteOrDisplayString(sc_toDisplayString);
});
sc_Vector.prototype.sc_toWriteString = _wrap_(function () {
    return this.sc_toWriteOrDisplayString(sc_toWriteString);
});
function sc_isVector(v) {
    return _wrap_(function (v) {
        return v instanceof sc_Vector;
    }).bind(this)(v);
}
function sc_isVectorEqual(v1, v2, comp) {
    return _wrap_(function (v1, v2, comp) {
        ...
        for (var i = 0; i < v1.length; i++)
            if (!comp(v1[i], v2[i]))
                return false;
        return true;
    }).bind(this)(v1, v2, comp);
}
function sc_makeVector(size, fill) {
    return _wrap_(function (size, fill) {
...
function sc_vectorRef(v, pos) {
    return _wrap_(function (v, pos) {
        return v[pos];
    }).bind(this)(v, pos);
}
function sc_vectorSetBang(v, pos, val) {
    return _wrap_(function (v, pos, val) {
        v[pos] = val;
    }).bind(this)(v, pos, val);
}
function sc_vector2list(a) {
    return _wrap_(function (a) {
        var res = null;
        for (var i = a.length - 1; i >= 0; i--)
            res = sc_cons(a[i], res);
        return res;
...
function sc_vectorFillBang(a, fill) {
    return _wrap_(function (a, fill) {
        for (var i = 0; i < a.length; i++)
            a[i] = fill;
    }).bind(this)(a, fill);
}
function sc_copyVector(a, len) {
    return _wrap_(function (a, len) {
        if (len <= a.length)
...
function sc_vectorCopy(a, start, end) {
    return _wrap_(function (a, start, end) {
        return a.slice(start, end);
    }).bind(this)(a, start, end);
}
function sc_vectorCopyBang(target, tstart, source, sstart, send) {
    return _wrap_(function (target, tstart, source, sstart, send) {
        if (!sstart)
            sstart = 0;
        if (!send)
            send = source.length;
        ...
        return target;
    }).bind(this)(target, tstart, source, sstart, send);
}
...
function sc_map(proc, l1) {
    return _wrap_(function (proc, l1) {
        if (l1 === undefined)
            return null;
...
function sc_filterMap2(proc, l1, l2) {
    return _wrap_(function (proc, l1, l2) {
        var revres = null;
        while (l1 !== null) {
        ...
        return sc_reverseAppendBang(revres, null);
    }).bind(this)(proc, l1, l2);
}
function sc_filterMap(proc, l1, l2, l3) {
    return _wrap_(function (proc, l1, l2, l3) {
        if (l2 === undefined)
        ...
        return sc_reverseAppendBang(revres, null);
    }).bind(this)(proc, l1, l2, l3);
}
function sc_any(proc, l) {
    return _wrap_(function (proc, l) {
        var revres = null;
        while (l !== null) {
            var tmp = proc(l.car);
            if (tmp !== false)
...
function sc_callWithValues(producer, consumer) {
    return _wrap_(function (producer, consumer) {
        var produced = producer();
        if (produced instanceof sc_Values)
            return consumer.apply(null, produced.values);
        else
            return consumer(produced);
    }).bind(this)(producer, consumer);
}
function sc_dynamicWind(before, thunk, after) {
    return _wrap_(function (before, thunk, after) {
        before();
        try {
            var res = thunk();
            return res;
    ...
    }).bind(this)(before, thunk, after);
}
function sc_Struct(name) {
    return _wrap_(function (name) {
        this.name = name;
    }).bind(this)(name);
}
sc_Struct.prototype.sc_toDisplayString = _wrap_(function () {
...
function sc_isStructNamed(name, s) {
    return _wrap_(function (name, s) {
        return s instanceof sc_Struct && s.name === name;
    }).bind(this)(name, s);
}
function sc_getStructField(s, name, field) {
    return _wrap_(function (s, name, field) {
        return s[field];
    }).bind(this)(s, name, field);
}
function sc_setStructFieldBang(s, name, field, val) {
    return _wrap_(function (s, name, field, val) {
        s[field] = val;
    }).bind(this)(s, name, field, val);
}
...
function sc_jsField(o, field) {
    return _wrap_(function (o, field) {
        return o[field];
    }).bind(this)(o, field);
}
function sc_setJsFieldBang(o, field, val) {
    return _wrap_(function (o, field, val) {
        return o[field] = val;
    }).bind(this)(o, field, val);
}
...
function sc_pregexp(re) {
    return _wrap_(function (re) {
        return new RegExp(sc_string2jsstring(re));
    }).bind(this)(re);
}
function sc_pregexpMatch(re, s) {
    return _wrap_(function (re, s) {
...
function sc_pregexpReplace(re, s1, s2) {
    return _wrap_(function (re, s1, s2) {
        var reg;
...
sc_Hashtable.prototype.toString = _wrap_(function () {
    return '#{%hashtable}';
});
function sc_HashtableElement(key, val) {
    return _wrap_(function (key, val) {
        this.key = key;
        this.val = val;
    }).bind(this)(key, val);
}
...
function sc_hashtablePutBang(ht, key, val) {
    return _wrap_(function (ht, key, val) {
        var hash = sc_hash(key);
        ht[hash] = new sc_HashtableElement(key, val);
    }).bind(this)(ht, key, val);
}
function sc_hashtableGet(ht, key) {
    return _wrap_(function (ht, key) {
        var hash = sc_hash(key);
        if (hash in ht)
            return ht[hash].val;
        else
...
function sc_Trampoline(args, maxTailCalls) {
    return _wrap_(function (args, maxTailCalls) {
        this['__trampoline return__'] = true;
        this.args = args;
        this.MAX_TAIL_CALLs = maxTailCalls;
    }).bind(this)(args, maxTailCalls);
}
sc_Trampoline.prototype.restart = _wrap_(function () {
    var o = this;
    while (true) {
...
function sc_bindExitLambda(proc) {
    return _wrap_(function (proc) {
        ...
        var escape = _wrap_(function (res) {
                escape_obj.res = res;
                throw escape_obj;
            });
        try {
...
sc_InputPort.prototype.peekChar = _wrap_(function () {
    if (!('peeked' in this))
        this.peeked = this.getNextChar();
    return this.peeked;
});
sc_InputPort.prototype.readChar = _wrap_(function () {
    var tmp = this.peekChar();
    delete this.peeked;
    return tmp;
});
sc_InputPort.prototype.isCharReady = _wrap_(function () {
    return true;
});
sc_InputPort.prototype.close = _wrap_(function () {
});
...
sc_ErrorInputPort.prototype.getNextChar = _wrap_(function () {
    throw 'can\'t read from error-port.';
});
sc_ErrorInputPort.prototype.isCharReady = _wrap_(function () {
    return false;
});
function sc_StringInputPort(jsStr) {
    return _wrap_(function (jsStr) {
        this.str = new String(jsStr);
        this.pos = 0;
    }).bind(this)(jsStr);
}
sc_StringInputPort.prototype = new sc_InputPort();
sc_StringInputPort.prototype.getNextChar = _wrap_(function () {
    if (this.pos >= this.str.length)
        return SC_EOF_OBJECT;
    return this.str.charAt(this.pos++);
});
function sc_Token(type, val, pos) {
    return _wrap_(function (type, val, pos) {
        this.type = type;
        this.val = val;
        this.pos = pos;
    }).bind(this)(type, val, pos);
}
sc_Token.EOF = 0;
sc_Token.OPEN_PAR = 1;
...
function sc_Tokenizer(port) {
    return _wrap_(function (port) {
        this.port = port;
    }).bind(this)(port);
}
sc_Tokenizer.prototype.peekToken = _wrap_(function () {
    if (this.peeked)
        return this.peeked;
...
sc_Tokenizer.prototype.readToken = _wrap_(function () {
    var tmp = this.peekToken();
    delete this.peeked;
    return tmp;
});
sc_Tokenizer.prototype.nextToken = _wrap_(function () {
    var port = this.port;
    ...
    function readIdOrNumber(firstChar) {
        return _wrap_(function (firstChar) {
            var res = firstChar;
...
function sc_Reader(tokenizer) {
    return _wrap_(function (tokenizer) {
        this.tokenizer = tokenizer;
        this.backref = new Array();
    }).bind(this)(tokenizer);
}
sc_Reader.prototype.read = _wrap_(function () {
    function readList(listBeginType) {
        return _wrap_(function (listBeginType) {
            function matchesPeer(open, close) {
                return _wrap_(function (open, close) {
                    return open === 1 && close === 2 || open === 3 && close === 4 || open === 5 && close === 6;
                }).bind(this)(open, close);
            }
            ;
            var res = null;
            while (true) {
...
function sc_withInputFromFile(s, thunk) {
    return _wrap_(function (s, thunk) {
        throw 'can\'t open ' + s;
    }).bind(this)(s, thunk);
}
...
function sc_withInputFromPort(p, thunk) {
    return _wrap_(function (p, thunk) {
        try {
...
sc_OutputPort.prototype.appendJSString = _wrap_(function (obj) {
});
sc_OutputPort.prototype.close = _wrap_(function () {
});
...
sc_StringOutputPort.prototype.appendJSString = _wrap_(function (s) {
    this.res += s;
});
sc_StringOutputPort.prototype.close = _wrap_(function () {
    return sc_jsstring2string(this.res);
});
function sc_getOutputString(sp) {
    return _wrap_(function (sp) {
...
sc_ErrorOutputPort.prototype.appendJSString = _wrap_(function (s) {
    throw 'don\'t write on ErrorPort!';
});
sc_ErrorOutputPort.prototype.close = _wrap_(function () {
});
function sc_GenericOutputPort(appendJSString, close) {
    return _wrap_(function (appendJSString, close) {
        this.appendJSString = appendJSString;
        if (close)
            this.close = close;
    }).bind(this)(appendJSString, close);
}
...
function sc_prepWriteCircle(o, symb, nbPointer) {
    return _wrap_(function (o, symb, nbPointer) {
    ...
    }).bind(this)(o, symb, nbPointer);
}
function sc_genToWriteCircleString(o, symb) {
    return _wrap_(function (o, symb) {
        if (!(o instanceof sc_Pair || o instanceof sc_Vector))
            return sc_toWriteString(o);
        return o.sc_toWriteCircleString(symb);
    }).bind(this)(o, symb);
}
sc_Pair.prototype.sc_toWriteCircleString = _wrap_(function (symb, inList) {
    if (this[symb + 'use']) {
        var nb = this[symb + 'nb'];
        if (this[symb]-- === 0) {
            delete this[symb];
...
sc_Vector.prototype.sc_toWriteCircleString = _wrap_(function (symb) {
    if (this[symb + 'use']) {
        var nb = this[symb + 'nb'];
        if (this[symb]-- === 0) {
            delete this[symb];
...
var sc_gensym = _wrap_(function () {
        var counter = 1000;
        return _wrap_(function (sym) {
            counter++;
            if (!sym)
...
function sc_substring(s, start, end) {
    return _wrap_(function (s, start, end) {
        return s.substring(start, end);
    }).bind(this)(s, start, end);
}
function sc_isSubstring_at(s1, s2, i) {
    return _wrap_(function (s1, s2, i) {
...
String.prototype.sc_toDisplayString = _wrap_(function () {
...
String.prototype.sc_toWriteString = _wrap_(function () {
    if (this.charAt(0) === sc_SYMBOL_PREFIX)
        return this.slice(1);
    else if (this.charAt(0) === sc_KEYWORD_PREFIX)
        return ':' + this.slice(1);
...
var sc_const_4_nboyer;
{
    ...
    BgL_nboyerzd2benchmarkzd2 = _wrap_(function () {
        var args = null;
        for (var sc_tmp = arguments.length - 1; sc_tmp >= 0; sc_tmp--) {
            args = sc_cons(arguments[sc_tmp], args);
        }
        var n;
        return n = args === null ? 0 : args.car, BgL_setupzd2boyerzd2(), BgL_runzd2benchmarkzd2('nboyer' + sc_number2string(n), 1, _wrap_(function () {
            return BgL_testzd2boyerzd2(n);
        }), _wrap_(function (rewrites) {
    ...
    BgL_setupzd2boyerzd2 = _wrap_(function () {
        return true;
    });
    BgL_testzd2boyerzd2 = _wrap_(function () {
        return true;
    });
    translate_term_nboyer = _wrap_(function (term) {
        var lst;
    ...
    translate_args_nboyer = _wrap_(function (lst) {
        var sc_lst_5;
        var term;
    ...
    untranslate_term_nboyer = _wrap_(function (term) {
        var optrOpnd;
        var tail1131;
        var L1127;
        var falseHead1130;
    ...
    BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer = _wrap_(function (sym) {
        var r;
        var x;
    ...
    translate_alist_nboyer = _wrap_(function (alist) {
        var sc_alist_6;
        var term;
    ...
    apply_subst_nboyer = _wrap_(function (alist, term) {
        var lst;
        var temp_temp;
    ...
    apply_subst_lst_nboyer = _wrap_(function (alist, lst) {
        var sc_lst_7;
    ...
    tautologyp_nboyer = _wrap_(function (sc_x_11, true_lst, false_lst) {
        var tmp1125;
        var x;
        var tmp1126;
        var sc_x_8;
    ...
    rewrite_nboyer = _wrap_(function (term) {
        var term2;
        var sc_term_12;
        var lst;
        var symbol_record;
    ...
    rewrite_args_nboyer = _wrap_(function (lst) {
        var sc_lst_14;
    ...
    one_way_unify1_nboyer = _wrap_(function (term1, term2) {
        var lst1;
        var lst2;
        var temp_temp;
    ...
    false_term_nboyer = '\u1E9C*';
    true_term_nboyer = '\u1E9C*';
    trans_of_implies1_nboyer = _wrap_(function (n) {
        var sc_n_15;
    ...
    is_term_equal_nboyer = _wrap_(function (x, y) {
        var lst1;
        var lst2;
        var r2;
        var r1;
    ...
    is_term_member_nboyer = _wrap_(function (x, lst) {
        var x;
        var lst;
        while (true) {
            if (lst === null)
    ...
    BgL_testzd2boyerzd2 = _wrap_(function (n) {
        var optrOpnd;
        var term;
        var sc_n_20;
        var answer;
...
var const_earley;
{
    ...
    BgL_makezd2parserzd2 = _wrap_(function (grammar, lexer) {
        var i;
        var parser_descr;
        var def_loop;
        var nb_nts;
        ...
        var ind;
        {
            ind = _wrap_(function (nt, sc_nts_10) {
                var i;
                {
            ...
            sc_nts_8 = (BgL_sc_defzd2loop_9zd2 = _wrap_(function (defs, sc_nts_11) {
                var rule_loop;
                var head;
                var def;
                return defs instanceof sc_Pair ? (def = defs.car, head = def.car, rule_loop = _wrap_(function (rules, sc_nts_12) {
                    var nt;
                    var l;
                    var sc_nts_13;
                    var rule;
            ...
            nb_confs = (BgL_sc_defzd2loop_6zd2 = _wrap_(function (defs, BgL_sc_nbzd2confs_14zd2) {
                var rule_loop;
                var def;
                return defs instanceof sc_Pair ? (def = defs.car, rule_loop = _wrap_(function (rules, BgL_sc_nbzd2confs_15zd2) {
                    var l;
            ...
            def_loop = _wrap_(function (defs, conf) {
                var rule_loop;
                var head;
                var def;
                return defs instanceof sc_Pair ? (def = defs.car, head = def.car, rule_loop = _wrap_(function (rules, conf, rule_num) {
                    var i;
                    var sc_i_17;
                    var nt;
                    var l;
            ...
            return _wrap_(function (input) {
                ...
                {
                    sc_ind_43 = _wrap_(function (nt, sc_nts_49) {
                        var i;
                        {
                    ...
                    make_states = _wrap_(function (BgL_sc_nbzd2toks_50zd2, BgL_sc_nbzd2confs_51zd2) {
                        var v;
                        var i;
                        var sc_states_52;
                        {
                    ...
                    BgL_sc_confzd2setzd2getza2_44za2 = _wrap_(function (state, BgL_sc_statezd2num_53zd2, sc_conf_54) {
                        var conf_set;
                    ...
                    conf_set_merge_new_bang = _wrap_(function (conf_set) {
                        return conf_set[conf_set[1] + 5] = conf_set[4], conf_set[1] = conf_set[3], conf_set[3] = -1, conf_set[4] = -1;
                    });
                    conf_set_adjoin = _wrap_(function (state, conf_set, sc_conf_56, i) {
                        var tail;
                    ...
                    BgL_sc_confzd2setzd2adjoinza2_45za2 = _wrap_(function (sc_states_57, BgL_sc_statezd2num_58zd2, l, i) {
                        var conf_set;
                        var sc_conf_59;
                        var l1;
                        var state;
                    ...
                    BgL_sc_confzd2setzd2adjoinza2za2_46z00 = _wrap_(function (sc_states_60, BgL_sc_statesza2_61za2, BgL_sc_statezd2num_62zd2, sc_conf_63, i) {
                    ...
                    conf_set_union = _wrap_(function (state, conf_set, sc_conf_66, other_set) {
                        var i;
                        {
                            i = other_set[2];
                            while (i >= 0) {
                    ...
                    forw = _wrap_(function (sc_states_67, BgL_sc_statezd2num_68zd2, sc_starters_69, sc_enders_70, sc_predictors_71, sc_steps_72, sc_nts_73) {
                        var next_set;
                        var next;
                        var conf_set;
                        var ender;
                    ...
                    is_parsed = _wrap_(function (nt, i, j, sc_nts_86, sc_enders_87, sc_states_88) {
                        var conf_set;
                        var state;
                        var sc_conf_89;
                        var l;
                    ...
                    deriv_trees = _wrap_(function (sc_conf_91, i, j, sc_enders_92, sc_steps_93, sc_names_94, sc_toks_95, sc_states_96, BgL_sc_nbzd2nts_97zd2) {
                        var sc_loop1_98;
                        var prev;
                        var name;
                        return name = sc_names_94[sc_conf_91], name !== false ? sc_conf_91 < BgL_sc_nbzd2nts_97zd2 ? sc_list(sc_list(name, sc_toks_95[i].car)) : sc_list(sc_list(name)) : (prev = sc_conf_91 - 1, sc_loop1_98 = _wrap_(function (l1, l2) {
                            var loop2;
                            var ender_set;
                            var state;
                            var ender;
                    ...
                    BgL_sc_derivzd2treesza2_47z70 = _wrap_(function (nt, i, j, sc_nts_101, sc_enders_102, sc_steps_103, sc_names_104, sc_toks_105, sc_states_106) {
                        var conf_set;
                        var state;
                        var sc_conf_107;
                        var l;
                    ...
                    nb_deriv_trees = _wrap_(function (sc_conf_110, i, j, sc_enders_111, sc_steps_112, sc_toks_113, sc_states_114, BgL_sc_nbzd2nts_115zd2) {
                        var sc_loop1_116;
                        var tmp1124;
                        var prev;
                        return prev = sc_conf_110 - 1, (tmp1124 = sc_conf_110 < BgL_sc_nbzd2nts_115zd2, tmp1124 !== false ? tmp1124 : sc_steps_112[prev] < 0) !== false ? 1 : (sc_loop1_116 = _wrap_(function (l, sc_n_118) {
                            var nb_ender_trees;
                            var nb_prev_trees;
                            var conf_set;
                            var state;
                    ...
                    BgL_sc_nbzd2derivzd2treesza2_48za2 = _wrap_(function (nt, i, j, sc_nts_119, sc_enders_120, sc_steps_121, sc_toks_122, sc_states_123) {
                        var conf_set;
                        var state;
                        var sc_conf_124;
                        var l;
                                        ...
                                        while (sc_i_130 >= 0) {
                                            {
                                                ...
                                                if (sc_conf_131 >= BgL_sc_nbzd2nts_24zd2 && sc_steps_25[prev] >= 0) {
                                                    sc_loop1_127 = _wrap_(function (l) {
                                                        var k;
                                                        var ender_set;
                                                        var state;
                                                        var ender;
    ...
    BgL_parsezd2ze3parsedzf3zc2 = _wrap_(function (parse, nt, i, j) {
        var is_parsed;
        var states;
        var enders;
        var nts;
    ...
    BgL_parsezd2ze3treesz31 = _wrap_(function (parse, nt, i, j) {
    ...
    BgL_parsezd2ze3nbzd2treesze3 = _wrap_(function (parse, nt, i, j) {
    ...
    test = _wrap_(function (k) {
        var x;
        var p;
        return p = BgL_makezd2parserzd2(const_earley, _wrap_(function (l) {
            var sc_x_134;
            var tail1134;
            var L1130;
            var falseHead1133;
    ...
    BgL_earleyzd2benchmarkzd2 = _wrap_(function () {
        var args = null;
        for (var sc_tmp = arguments.length - 1; sc_tmp >= 0; sc_tmp--) {
            args = sc_cons(arguments[sc_tmp], args);
        }
        var k;
        return k = args === null ? 7 : args.car, BgL_runzd2benchmarkzd2('earley', 1, _wrap_(function () {
            return test(k);
        }), _wrap_(function (result) {
            return sc_display(result), sc_newline(), result == 132;
        }));
    });
}
SC_DEFAULT_OUT = new sc_GenericOutputPort(_wrap_(function (s) {
}));
SC_ERROR_OUT = SC_DEFAULT_OUT;
function RunBenchmark(name, count, run, warn) {
    return _wrap_(function (name, count, run, warn) {
