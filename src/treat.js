...
var TreatJS = TreatJS || (function() {
  ...
  */
  const version = "TreatJS 2.0.3 (Alpha)";
  ...
  */
  ...
  // ___    _         _   _ _          ___          _       
  //|_ _|__| |___ _ _| |_(_) |_ _  _  | _ \___ __ _| |_ __  
  // | |/ _` / -_) ' \  _| |  _| || | |   / -_) _` | | '  \ 
  //|___\__,_\___|_||_\__|_|\__|\_, | |_|_\___\__,_|_|_|_|_|
  //                            |__/                        
  ...
  */
  ...
  function build({name, constructor}, Configuration) {
    ...
    const package = constructor(TreatJS, Contract, Configuration, Realm);
