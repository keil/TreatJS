...
(function(TreatJS) {
  ...
  function build() {
    ...
    make(Contract, "ConstructorX", TreatJS.Contract.Constructor);
    ...
    make(Contract, "Invariant", TreatJS.Contract.Invariant);
    ...
    make(Contract, "Name", TreatJS.Contract.Name);
    make(Contract, "Where", TreatJS.Contract.Where);
    make(Contract, "Temporal", TreatJS.Contract.Temporal);
    make(Contract, "Yield", TreatJS.Contract.Yield);
