        ...
        function ScopeHandler(allowedScope) {
                this.get = function (target, key) {
                        ...
                        if(key in allowedScope)
                                return wrap(allowedScope[key], allowedScope) || undefined;
                        else 
...
var string = "("+test.toString()+").apply(wrap({},{}));";
with(wrap({}, {eval:eval, print:print, string:string, wrap:wrap, test2:test2})) {
