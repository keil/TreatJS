...
/* CONTRACT */ $.assert(__sc_LINE, IsNumber); 
/* CONTRACT */ $.assert(__sc_FILE, IsString); 
...
/* CONTRACT */ sc_typeof = $.assert(sc_typeof, $.FunctionContract(True,IsString));
...
/* CONTRACT */ sc_getprop = $.assert(sc_getprop, $.FunctionContract(True,Any));
