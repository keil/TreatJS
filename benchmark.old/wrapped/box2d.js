...
_wrap_(function (F, G) {
    ...
    F.inherit = _wrap_(function (y, w) {
        K.prototype = w.prototype;
        y.prototype = new K();
        y.prototype.constructor = y;
    });
    F.generateCallback = _wrap_(function (y, w) {
        return _wrap_(function () {
            w.apply(y, arguments);
        });
    });
    F.NVector = _wrap_(function (y) {
        if (y === G)
            y = 0;
...
_wrap_(function () {
    ...
    B.b2AABB = _wrap_(function () {
        this.lowerBound = new p();
        this.upperBound = new p();
    });
    B.prototype.IsValid = _wrap_(function () {
    ...
    B.prototype.RayCast = _wrap_(function (b, e) {
    ...
    B.prototype.TestOverlap = _wrap_(function (b) {
    ...
    B.Combine = _wrap_(function (b, e) {
        var f = new B();
        f.Combine(b, e);
        return f;
    });
    B.prototype.Combine = _wrap_(function (b, e) {
    ...
    Q.b2Bound = _wrap_(function () {
    });
    Q.prototype.IsLower = _wrap_(function () {
        return (this.value & 1) == 0;
    });
    Q.prototype.IsUpper = _wrap_(function () {
        return (this.value & 1) == 1;
    });
    Q.prototype.Swap = _wrap_(function (b) {
    ...
    V.b2BoundValues = _wrap_(function () {
    });
    V.prototype.b2BoundValues = _wrap_(function () {
    ...
    M.b2Collision = _wrap_(function () {
    });
    M.ClipSegmentToLine = _wrap_(function (b, e, f, m) {
        if (m === undefined)
            m = 0;
        var r, s = 0;
        r = e[0];
    ...
    M.EdgeSeparation = _wrap_(function (b, e, f, m, r) {
        if (f === undefined)
            f = 0;
    ...
    M.FindMaxSeparation = _wrap_(function (b, e, f, m, r) {
    ...
    M.FindIncidentEdge = _wrap_(function (b, e, f, m, r, s) {
        if (m === undefined)
            m = 0;
    ...
    M.MakeClipPointVector = _wrap_(function () {
        var b = new Vector(2);
        b[0] = new a();
        b[1] = new a();
        return b;
    });
    M.CollidePolygons = _wrap_(function (b, e, f, m, r) {
        var s;
        b.m_pointCount = 0;
    ...
    M.CollideCircles = _wrap_(function (b, e, f, m, r) {
        b.m_pointCount = 0;
        var s, v;
        s = f.R;
        v = e.m_p;
    ...
    M.CollidePolygonAndCircle = _wrap_(function (b, e, f, m, r) {
    ...
    M.TestOverlap = _wrap_(function (b, e) {
    ...
    Box2D.postDefs.push(_wrap_(function () {
    ...
    L.b2ContactID = _wrap_(function () {
        this.features = new c();
    });
    L.prototype.b2ContactID = _wrap_(function () {
        this.features._m_id = this;
    });
    L.prototype.Set = _wrap_(function (b) {
        this.key = b._key;
    });
    L.prototype.Copy = _wrap_(function () {
        var b = new L();
        b.key = this.key;
        return b;
    });
    ...
    I.b2ContactPoint = _wrap_(function () {
        this.position = new p();
        this.velocity = new p();
        this.normal = new p();
        this.id = new L();
    });
    W.b2Distance = _wrap_(function () {
    });
    W.Distance = _wrap_(function (b, e, f) {
        ++W.b2_gjkCalls;
    ...
    Y.b2DistanceInput = _wrap_(function () {
    });
    k.b2DistanceOutput = _wrap_(function () {
        this.pointA = new p();
        this.pointB = new p();
    });
    z.b2DistanceProxy = _wrap_(function () {
    });
    z.prototype.Set = _wrap_(function (b) {
        switch (b.GetType()) {
    ...
    z.prototype.GetSupport = _wrap_(function (b) {
    ...
    z.prototype.GetSupportVertex = _wrap_(function (b) {
        for (var e = 0, f = this.m_vertices[0].x * b.x + this.m_vertices[0].y * b.y, m = 1; m < this.m_count; ++m) {
            var r = this.m_vertices[m].x * b.x + this.m_vertices[m].y * b.y;
            if (r > f) {
                e = m;
    ...
    z.prototype.GetVertexCount = _wrap_(function () {
        return this.m_count;
    });
    z.prototype.GetVertex = _wrap_(function (b) {
        if (b === undefined)
            b = 0;
        y.b2Assert(0 <= b && b < this.m_count);
        return this.m_vertices[b];
    });
    u.b2DynamicTree = _wrap_(function () {
    });
    u.prototype.b2DynamicTree = _wrap_(function () {
        this.m_freeList = this.m_root = null;
        this.m_insertionCount = this.m_path = 0;
    });
    u.prototype.CreateProxy = _wrap_(function (b, e) {
    ...
    u.prototype.DestroyProxy = _wrap_(function (b) {
        this.RemoveLeaf(b);
        this.FreeNode(b);
    });
    u.prototype.MoveProxy = _wrap_(function (b, e, f) {
        y.b2Assert(b.IsLeaf());
    ...
    u.prototype.Rebalance = _wrap_(function (b) {
        if (b === undefined)
            b = 0;
        if (this.m_root != null)
            for (var e = 0; e < b; e++) {
    ...
    u.prototype.GetFatAABB = _wrap_(function (b) {
        return b.aabb;
    });
    u.prototype.GetUserData = _wrap_(function (b) {
        return b.userData;
    });
    u.prototype.Query = _wrap_(function (b, e) {
        if (this.m_root != null) {
    ...
    u.prototype.RayCast = _wrap_(function (b, e) {
        if (this.m_root != null) {
    ...
    u.prototype.AllocateNode = _wrap_(function () {
        if (this.m_freeList) {
    ...
    u.prototype.FreeNode = _wrap_(function (b) {
        b.parent = this.m_freeList;
        this.m_freeList = b;
    });
    u.prototype.InsertLeaf = _wrap_(function (b) {
    ...
    u.prototype.RemoveLeaf = _wrap_(function (b) {
        if (b == this.m_root)
            this.m_root = null;
        else {
    ...
    D.b2DynamicTreeBroadPhase = _wrap_(function () {
        this.m_tree = new u();
        this.m_moveBuffer = new Vector();
        this.m_pairBuffer = new Vector();
        this.m_pairCount = 0;
    });
    D.prototype.CreateProxy = _wrap_(function (b, e) {
        var f = this.m_tree.CreateProxy(b, e);
        ++this.m_proxyCount;
        this.BufferMove(f);
        return f;
    });
    D.prototype.DestroyProxy = _wrap_(function (b) {
        this.UnBufferMove(b);
        --this.m_proxyCount;
        this.m_tree.DestroyProxy(b);
    });
    D.prototype.MoveProxy = _wrap_(function (b, e, f) {
        this.m_tree.MoveProxy(b, e, f) && this.BufferMove(b);
    });
    D.prototype.TestOverlap = _wrap_(function (b, e) {
        var f = this.m_tree.GetFatAABB(b), m = this.m_tree.GetFatAABB(e);
        return f.TestOverlap(m);
    });
    D.prototype.GetUserData = _wrap_(function (b) {
        return this.m_tree.GetUserData(b);
    });
    D.prototype.GetFatAABB = _wrap_(function (b) {
        return this.m_tree.GetFatAABB(b);
    });
    D.prototype.GetProxyCount = _wrap_(function () {
        return this.m_proxyCount;
    });
    D.prototype.UpdatePairs = _wrap_(function (b) {
        var e = this;
        var f = e.m_pairCount = 0, m;
        for (f = 0; f < e.m_moveBuffer.length; ++f) {
            m = e.m_moveBuffer[f];
            var r = e.m_tree.GetFatAABB(m);
            e.m_tree.Query(_wrap_(function (t) {
                if (t == m)
                    return true;
    ...
    D.prototype.Query = _wrap_(function (b, e) {
        this.m_tree.Query(b, e);
    });
    D.prototype.RayCast = _wrap_(function (b, e) {
        this.m_tree.RayCast(b, e);
    });
    D.prototype.Validate = _wrap_(function () {
    });
    D.prototype.Rebalance = _wrap_(function (b) {
        if (b === undefined)
            b = 0;
        this.m_tree.Rebalance(b);
    });
    D.prototype.BufferMove = _wrap_(function (b) {
        this.m_moveBuffer[this.m_moveBuffer.length] = b;
    });
    D.prototype.UnBufferMove = _wrap_(function (b) {
        this.m_moveBuffer.splice(parseInt(this.m_moveBuffer.indexOf(b)), 1);
    });
    D.prototype.ComparePairs = _wrap_(function () {
        return 0;
    });
    D.__implements = {};
    D.__implements[g] = true;
    H.b2DynamicTreeNode = _wrap_(function () {
        this.aabb = new B();
    });
    H.prototype.IsLeaf = _wrap_(function () {
        return this.child1 == null;
    });
    O.b2DynamicTreePair = _wrap_(function () {
    });
    E.b2Manifold = _wrap_(function () {
        this.m_pointCount = 0;
    });
    E.prototype.b2Manifold = _wrap_(function () {
    ...
    E.prototype.Reset = _wrap_(function () {
        for (var b = 0; b < y.b2_maxManifoldPoints; b++)
    ...
    E.prototype.Set = _wrap_(function (b) {
    ...
    E.prototype.Copy = _wrap_(function () {
        var b = new E();
        b.Set(this);
        return b;
    });
    ...
    R.b2ManifoldPoint = _wrap_(function () {
        this.m_localPoint = new p();
        this.m_id = new L();
    });
    R.prototype.b2ManifoldPoint = _wrap_(function () {
        this.Reset();
    });
    R.prototype.Reset = _wrap_(function () {
        this.m_localPoint.SetZero();
        this.m_tangentImpulse = this.m_normalImpulse = 0;
        this.m_id.key = 0;
    });
    R.prototype.Set = _wrap_(function (b) {
        this.m_localPoint.SetV(b.m_localPoint);
        this.m_normalImpulse = b.m_normalImpulse;
        this.m_tangentImpulse = b.m_tangentImpulse;
        this.m_id.Set(b.m_id);
    });
    N.b2Point = _wrap_(function () {
        this.p = new p();
    });
    N.prototype.Support = _wrap_(function () {
        return this.p;
    });
    N.prototype.GetFirstVertex = _wrap_(function () {
        return this.p;
    });
    S.b2RayCastInput = _wrap_(function () {
        this.p1 = new p();
        this.p2 = new p();
    });
    S.prototype.b2RayCastInput = _wrap_(function (b, e, f) {
        if (b === undefined)
            b = null;
        if (e === undefined)
            e = null;
    ...
    aa.b2RayCastOutput = _wrap_(function () {
        this.normal = new p();
    });
    Z.b2Segment = _wrap_(function () {
        this.p1 = new p();
        this.p2 = new p();
    });
    Z.prototype.TestSegment = _wrap_(function (b, e, f, m) {
        if (m === undefined)
            m = 0;
    ...
    Z.prototype.Extend = _wrap_(function (b) {
        this.ExtendForward(b);
        this.ExtendBackward(b);
    });
    Z.prototype.ExtendForward = _wrap_(function (b) {
    ...
    Z.prototype.ExtendBackward = _wrap_(function (b) {
        var e = -this.p2.x + this.p1.x, f = -this.p2.y + this.p1.y;
    ...
    d.b2SeparationFunction = _wrap_(function () {
        this.m_localPoint = new p();
        this.m_axis = new p();
    });
    d.prototype.Initialize = _wrap_(function (b, e, f, m, r) {
        this.m_proxyA = e;
        this.m_proxyB = m;
    ...
    d.prototype.Evaluate = _wrap_(function (b, e) {
        var f, m, r = 0;
        switch (this.m_type) {
        case d.e_points:
    ...
    h.b2Simplex = _wrap_(function () {
        this.m_v1 = new j();
        this.m_v2 = new j();
        this.m_v3 = new j();
        this.m_vertices = new Vector(3);
    });
    h.prototype.b2Simplex = _wrap_(function () {
        this.m_vertices[0] = this.m_v1;
        this.m_vertices[1] = this.m_v2;
        this.m_vertices[2] = this.m_v3;
    });
    h.prototype.ReadCache = _wrap_(function (b, e, f, m, r) {
    ...
    h.prototype.WriteCache = _wrap_(function (b) {
    ...
    h.prototype.GetSearchDirection = _wrap_(function () {
        switch (this.m_count) {
        case 1:
    ...
    h.prototype.GetClosestPoint = _wrap_(function () {
        switch (this.m_count) {
        case 0:
            y.b2Assert(false);
            return new p();
    ...
    h.prototype.GetWitnessPoints = _wrap_(function (b, e) {
        switch (this.m_count) {
        case 0:
            y.b2Assert(false);
            break;
    ...
    h.prototype.GetMetric = _wrap_(function () {
        switch (this.m_count) {
        case 0:
            y.b2Assert(false);
            return 0;
    ...
    h.prototype.Solve2 = _wrap_(function () {
    ...
    h.prototype.Solve3 = _wrap_(function () {
    ...
    l.b2SimplexCache = _wrap_(function () {
        this.indexA = new Vector_a2j_Number(3);
        this.indexB = new Vector_a2j_Number(3);
    });
    j.b2SimplexVertex = _wrap_(function () {
    });
    j.prototype.Set = _wrap_(function (b) {
        this.wA.SetV(b.wA);
        this.wB.SetV(b.wB);
        this.w.SetV(b.w);
        this.a = b.a;
    ...
    o.b2TimeOfImpact = _wrap_(function () {
    });
    o.TimeOfImpact = _wrap_(function (b) {
        ++o.b2_toiCalls;
    ...
    q.b2TOIInput = _wrap_(function () {
        this.proxyA = new z();
        this.proxyB = new z();
        this.sweepA = new A();
        this.sweepB = new A();
    });
    n.b2WorldManifold = _wrap_(function () {
        this.m_normal = new p();
    });
    n.prototype.b2WorldManifold = _wrap_(function () {
        this.m_points = new Vector(y.b2_maxManifoldPoints);
        for (var b = 0; b < y.b2_maxManifoldPoints; b++)
            this.m_points[b] = new p();
    });
    n.prototype.Initialize = _wrap_(function (b, e, f, m, r) {
        if (f === undefined)
            f = 0;
        if (r === undefined)
            r = 0;
    ...
    a.ClipVertex = _wrap_(function () {
        this.v = new p();
        this.id = new L();
    });
    a.prototype.Set = _wrap_(function (b) {
        this.v.SetV(b.v);
        this.id.Set(b.id);
    });
    c.Features = _wrap_(function () {
    });
...
_wrap_(function () {
    ...
    G.b2CircleShape = _wrap_(function () {
        Box2D.Collision.Shapes.b2Shape.b2Shape.apply(this, arguments);
        this.m_p = new V();
    });
    G.prototype.Copy = _wrap_(function () {
        var k = new G();
        k.Set(this);
        return k;
    });
    G.prototype.Set = _wrap_(function (k) {
        this.__super.Set.call(this, k);
        if (Box2D.is(k, G))
            this.m_p.SetV((k instanceof G ? k : null).m_p);
    });
    G.prototype.TestPoint = _wrap_(function (k, z) {
    ...
    G.prototype.RayCast = _wrap_(function (k, z, u) {
    ...
    G.prototype.ComputeAABB = _wrap_(function (k, z) {
    ...
    G.prototype.ComputeMass = _wrap_(function (k, z) {
        if (z === undefined)
            z = 0;
    ...
    G.prototype.ComputeSubmergedArea = _wrap_(function (k, z, u, D) {
        if (z === undefined)
            z = 0;
        u = B.MulX(u, this.m_p);
        var H = -(B.Dot(k, u) - z);
    ...
    G.prototype.GetLocalPosition = _wrap_(function () {
        return this.m_p;
    });
    G.prototype.SetLocalPosition = _wrap_(function (k) {
        this.m_p.SetV(k);
    });
    G.prototype.GetRadius = _wrap_(function () {
        return this.m_radius;
    });
    G.prototype.SetRadius = _wrap_(function (k) {
        if (k === undefined)
            k = 0;
        this.m_radius = k;
    });
    G.prototype.b2CircleShape = _wrap_(function (k) {
        if (k === undefined)
            k = 0;
    ...
    K.b2EdgeChainDef = _wrap_(function () {
    });
    K.prototype.b2EdgeChainDef = _wrap_(function () {
        this.vertexCount = 0;
        this.isALoop = true;
        this.vertices = [];
    });
    ...
    y.prototype.TestPoint = _wrap_(function () {
        return false;
    });
    y.prototype.RayCast = _wrap_(function (k, z, u) {
    ...
    y.prototype.ComputeAABB = _wrap_(function (k, z) {
    ...
    y.prototype.ComputeMass = _wrap_(function (k) {
        k.mass = 0;
        k.center.SetV(this.m_v1);
        k.I = 0;
    });
    y.prototype.ComputeSubmergedArea = _wrap_(function (k, z, u, D) {
        if (z === undefined)
            z = 0;
    ...
    y.prototype.GetLength = _wrap_(function () {
        return this.m_length;
    });
    y.prototype.GetVertex1 = _wrap_(function () {
        return this.m_v1;
    });
    y.prototype.GetVertex2 = _wrap_(function () {
        return this.m_v2;
    });
    y.prototype.GetCoreVertex1 = _wrap_(function () {
        return this.m_coreV1;
    });
    y.prototype.GetCoreVertex2 = _wrap_(function () {
        return this.m_coreV2;
    });
    y.prototype.GetNormalVector = _wrap_(function () {
        return this.m_normal;
    });
    y.prototype.GetDirectionVector = _wrap_(function () {
        return this.m_direction;
    });
    y.prototype.GetCorner1Vector = _wrap_(function () {
        return this.m_cornerDir1;
    });
    y.prototype.GetCorner2Vector = _wrap_(function () {
        return this.m_cornerDir2;
    });
    y.prototype.Corner1IsConvex = _wrap_(function () {
        return this.m_cornerConvex1;
    });
    y.prototype.Corner2IsConvex = _wrap_(function () {
        return this.m_cornerConvex2;
    });
    y.prototype.GetFirstVertex = _wrap_(function (k) {
        var z = k.R;
    ...
    y.prototype.GetNextEdge = _wrap_(function () {
        return this.m_nextEdge;
    });
    y.prototype.GetPrevEdge = _wrap_(function () {
        return this.m_prevEdge;
    });
    y.prototype.Support = _wrap_(function (k, z, u) {
        if (z === undefined)
            z = 0;
        if (u === undefined)
            u = 0;
    ...
    y.prototype.b2EdgeShape = _wrap_(function (k, z) {
        this.__super.b2Shape.call(this);
    ...
    y.prototype.SetPrevEdge = _wrap_(function (k, z, u, D) {
        this.m_prevEdge = k;
        this.m_coreV1 = z;
        this.m_cornerDir1 = u;
        this.m_cornerConvex1 = D;
    });
    y.prototype.SetNextEdge = _wrap_(function (k, z, u, D) {
        this.m_nextEdge = k;
        this.m_coreV2 = z;
        this.m_cornerDir2 = u;
        this.m_cornerConvex2 = D;
    });
    w.b2MassData = _wrap_(function () {
        this.mass = 0;
    ...
    A.b2PolygonShape = _wrap_(function () {
        Box2D.Collision.Shapes.b2Shape.b2Shape.apply(this, arguments);
    });
    A.prototype.Copy = _wrap_(function () {
        var k = new A();
        k.Set(this);
        return k;
    });
    A.prototype.Set = _wrap_(function (k) {
        this.__super.Set.call(this, k);
        if (Box2D.is(k, A)) {
    ...
    A.prototype.SetAsArray = _wrap_(function (k, z) {
        if (z === undefined)
            z = 0;
    ...
    A.prototype.SetAsVector = _wrap_(function (k, z) {
        if (z === undefined)
            z = 0;
        if (z == 0)
            z = k.length;
    ...
    A.AsVector = _wrap_(function (k, z) {
        if (z === undefined)
            z = 0;
        var u = new A();
        u.SetAsVector(k, z);
    ...
    A.prototype.SetAsBox = _wrap_(function (k, z) {
        if (k === undefined)
            k = 0;
        if (z === undefined)
            z = 0;
    ...
    A.prototype.SetAsOrientedBox = _wrap_(function (k, z, u, D) {
        if (k === undefined)
            k = 0;
        if (z === undefined)
            z = 0;
    ...
    A.AsOrientedBox = _wrap_(function (k, z, u, D) {
        if (k === undefined)
            k = 0;
        if (z === undefined)
            z = 0;
    ...
    A.prototype.SetAsEdge = _wrap_(function (k, z) {
    ...
    A.AsEdge = _wrap_(function (k, z) {
        var u = new A();
        u.SetAsEdge(k, z);
        return u;
    });
    A.prototype.TestPoint = _wrap_(function (k, z) {
        var u;
        u = k.R;
    ...
    A.prototype.RayCast = _wrap_(function (k, z, u) {
    ...
    A.prototype.ComputeAABB = _wrap_(function (k, z) {
    ...
    A.prototype.ComputeMass = _wrap_(function (k, z) {
        if (z === undefined)
            z = 0;
    ...
    A.prototype.ComputeSubmergedArea = _wrap_(function (k, z, u, D) {
        if (z === undefined)
            z = 0;
    ...
    A.prototype.GetVertexCount = _wrap_(function () {
        return this.m_vertexCount;
    });
    A.prototype.GetVertices = _wrap_(function () {
        return this.m_vertices;
    });
    A.prototype.GetNormals = _wrap_(function () {
        return this.m_normals;
    });
    A.prototype.GetSupport = _wrap_(function (k) {
    ...
    A.prototype.GetSupportVertex = _wrap_(function (k) {
        for (var z = 0, u = this.m_vertices[0].x * k.x + this.m_vertices[0].y * k.y, D = 1; D < this.m_vertexCount; ++D) {
            var H = this.m_vertices[D].x * k.x + this.m_vertices[D].y * k.y;
            if (H > u) {
                z = D;
    ...
    A.prototype.Validate = _wrap_(function () {
        return false;
    });
    A.prototype.b2PolygonShape = _wrap_(function () {
        this.__super.b2Shape.call(this);
    ...
    A.prototype.Reserve = _wrap_(function (k) {
        if (k === undefined)
            k = 0;
    ...
    A.ComputeCentroid = _wrap_(function (k, z) {
        if (z === undefined)
            z = 0;
    ...
    A.ComputeOBB = _wrap_(function (k, z, u) {
        if (u === undefined)
            u = 0;
    ...
    U.b2Shape = _wrap_(function () {
    });
    U.prototype.Copy = _wrap_(function () {
        return null;
    });
    U.prototype.Set = _wrap_(function (k) {
        this.m_radius = k.m_radius;
    });
    U.prototype.GetType = _wrap_(function () {
        return this.m_type;
    });
    U.prototype.TestPoint = _wrap_(function () {
        return false;
    });
    U.prototype.RayCast = _wrap_(function () {
        return false;
    });
    U.prototype.ComputeAABB = _wrap_(function () {
    });
    U.prototype.ComputeMass = _wrap_(function () {
    });
    U.prototype.ComputeSubmergedArea = _wrap_(function () {
        return 0;
    });
    U.TestOverlap = _wrap_(function (k, z, u, D) {
        var H = new L();
        H.proxyA = new W();
        H.proxyA.Set(k);
        H.proxyB = new W();
    ...
    U.prototype.b2Shape = _wrap_(function () {
...
_wrap_(function () {
    ...
    F.b2Color = _wrap_(function () {
        this._b = this._g = this._r = 0;
    });
    F.prototype.b2Color = _wrap_(function (y, w, A) {
        if (y === undefined)
            y = 0;
        if (w === undefined)
            w = 0;
    ...
    F.prototype.Set = _wrap_(function (y, w, A) {
        if (y === undefined)
            y = 0;
        if (w === undefined)
            w = 0;
    ...
    G.b2Settings = _wrap_(function () {
    });
    G.b2MixFriction = _wrap_(function (y, w) {
        if (y === undefined)
            y = 0;
        if (w === undefined)
            w = 0;
    ...
    G.b2MixRestitution = _wrap_(function (y, w) {
        if (y === undefined)
            y = 0;
        if (w === undefined)
            w = 0;
...
_wrap_(function () {
    ...
    F.b2Mat22 = _wrap_(function () {
        this.col1 = new A();
        this.col2 = new A();
    });
    F.prototype.b2Mat22 = _wrap_(function () {
        this.SetIdentity();
    });
    F.FromAngle = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        var B = new F();
        B.Set(p);
    ...
    F.FromVV = _wrap_(function (p, B) {
        var Q = new F();
        Q.SetVV(p, B);
        return Q;
    });
    F.prototype.Set = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        var B = Math.cos(p);
        p = Math.sin(p);
    ...
    F.prototype.SetVV = _wrap_(function (p, B) {
        this.col1.SetV(p);
        this.col2.SetV(B);
    });
    F.prototype.Copy = _wrap_(function () {
        var p = new F();
        p.SetM(this);
        return p;
    });
    F.prototype.SetM = _wrap_(function (p) {
        this.col1.SetV(p.col1);
        this.col2.SetV(p.col2);
    });
    F.prototype.AddM = _wrap_(function (p) {
        this.col1.x += p.col1.x;
        this.col1.y += p.col1.y;
        this.col2.x += p.col2.x;
        this.col2.y += p.col2.y;
    });
    F.prototype.SetIdentity = _wrap_(function () {
        this.col1.x = 1;
        this.col2.x = 0;
        this.col1.y = 0;
        this.col2.y = 1;
    });
    F.prototype.SetZero = _wrap_(function () {
        this.col1.x = 0;
        this.col2.x = 0;
        this.col1.y = 0;
        this.col2.y = 0;
    });
    F.prototype.GetAngle = _wrap_(function () {
        return Math.atan2(this.col1.y, this.col1.x);
    });
    F.prototype.GetInverse = _wrap_(function (p) {
    ...
    F.prototype.Solve = _wrap_(function (p, B, Q) {
        if (B === undefined)
            B = 0;
        if (Q === undefined)
            Q = 0;
    ...
    F.prototype.Abs = _wrap_(function () {
        this.col1.Abs();
        this.col2.Abs();
    });
    G.b2Mat33 = _wrap_(function () {
        this.col1 = new U();
        this.col2 = new U();
        this.col3 = new U();
    });
    G.prototype.b2Mat33 = _wrap_(function (p, B, Q) {
        if (p === undefined)
            p = null;
        if (B === undefined)
            B = null;
    ...
    G.prototype.SetVVV = _wrap_(function (p, B, Q) {
        this.col1.SetV(p);
        this.col2.SetV(B);
        this.col3.SetV(Q);
    });
    ...
    G.prototype.SetM = _wrap_(function (p) {
        this.col1.SetV(p.col1);
        this.col2.SetV(p.col2);
        this.col3.SetV(p.col3);
    });
    G.prototype.AddM = _wrap_(function (p) {
        this.col1.x += p.col1.x;
        this.col1.y += p.col1.y;
    ...
    G.prototype.SetIdentity = _wrap_(function () {
        this.col1.x = 1;
        this.col2.x = 0;
        this.col3.x = 0;
        this.col1.y = 0;
    ...
    G.prototype.SetZero = _wrap_(function () {
        this.col1.x = 0;
        this.col2.x = 0;
        this.col3.x = 0;
        this.col1.y = 0;
    ...
    G.prototype.Solve22 = _wrap_(function (p, B, Q) {
        if (B === undefined)
            B = 0;
        if (Q === undefined)
            Q = 0;
    ...
    G.prototype.Solve33 = _wrap_(function (p, B, Q, V) {
        if (B === undefined)
            B = 0;
        if (Q === undefined)
            Q = 0;
    ...
    K.MinV = _wrap_(function (p, B) {
        return new A(K.Min(p.x, B.x), K.Min(p.y, B.y));
    });
    K.Max = _wrap_(function (p, B) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    K.MaxV = _wrap_(function (p, B) {
        return new A(K.Max(p.x, B.x), K.Max(p.y, B.y));
    });
    K.Clamp = _wrap_(function (p, B, Q) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    K.ClampV = _wrap_(function (p, B, Q) {
        return K.MaxV(B, K.MinV(p, Q));
    });
    K.Swap = _wrap_(function (p, B) {
        var Q = p[0];
        p[0] = B[0];
        B[0] = Q;
    });
    K.Random = _wrap_(function () {
        return Math.random() * 2 - 1;
    });
    K.RandomRange = _wrap_(function (p, B) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    K.NextPowerOfTwo = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        p |= p >> 1 & 2147483647;
        p |= p >> 2 & 1073741823;
    ...
    K.IsPowerOfTwo = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        return p > 0 && (p & p - 1) == 0;
    });
    ...
    y.b2Sweep = _wrap_(function () {
        this.localCenter = new A();
        this.c0 = new A();
        this.c = new A();
    });
    y.prototype.Set = _wrap_(function (p) {
    ...
    y.prototype.Copy = _wrap_(function () {
        var p = new y();
    ...
    y.prototype.GetTransform = _wrap_(function (p, B) {
        if (B === undefined)
            B = 0;
    ...
    y.prototype.Advance = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
    ...
    w.b2Transform = _wrap_(function () {
        this.position = new A();
        this.R = new F();
    });
    w.prototype.b2Transform = _wrap_(function (p, B) {
        if (p === undefined)
            p = null;
        if (B === undefined)
            B = null;
    ...
    w.prototype.Initialize = _wrap_(function (p, B) {
        this.position.SetV(p);
        this.R.SetM(B);
    });
    w.prototype.SetIdentity = _wrap_(function () {
        this.position.SetZero();
        this.R.SetIdentity();
    });
    w.prototype.Set = _wrap_(function (p) {
        this.position.SetV(p.position);
        this.R.SetM(p.R);
    });
    w.prototype.GetAngle = _wrap_(function () {
        return Math.atan2(this.R.col1.y, this.R.col1.x);
    });
    A.b2Vec2 = _wrap_(function () {
    });
    A.prototype.b2Vec2 = _wrap_(function (p, B) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    A.prototype.SetZero = _wrap_(function () {
        this.y = this.x = 0;
    });
    A.prototype.Set = _wrap_(function (p, B) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    A.prototype.SetV = _wrap_(function (p) {
        this.x = p.x;
        this.y = p.y;
    });
    A.prototype.GetNegative = _wrap_(function () {
        return new A(-this.x, -this.y);
    });
    A.prototype.NegativeSelf = _wrap_(function () {
        this.x = -this.x;
        this.y = -this.y;
    });
    A.Make = _wrap_(function (p, B) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    A.prototype.Add = _wrap_(function (p) {
        this.x += p.x;
        this.y += p.y;
    });
    A.prototype.Subtract = _wrap_(function (p) {
        this.x -= p.x;
        this.y -= p.y;
    });
    A.prototype.Multiply = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        this.x *= p;
        this.y *= p;
    });
    A.prototype.MulM = _wrap_(function (p) {
        var B = this.x;
        this.x = p.col1.x * B + p.col2.x * this.y;
        this.y = p.col1.y * B + p.col2.y * this.y;
    });
    A.prototype.MulTM = _wrap_(function (p) {
        var B = K.Dot(this, p.col1);
        this.y = K.Dot(this, p.col2);
        this.x = B;
    });
    A.prototype.CrossVF = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        var B = this.x;
        this.x = p * this.y;
    ...
    A.prototype.CrossFV = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        var B = this.x;
        this.x = -p * this.y;
    ...
    A.prototype.MinV = _wrap_(function (p) {
        this.x = this.x < p.x ? this.x : p.x;
        this.y = this.y < p.y ? this.y : p.y;
    });
    A.prototype.MaxV = _wrap_(function (p) {
        this.x = this.x > p.x ? this.x : p.x;
        this.y = this.y > p.y ? this.y : p.y;
    });
    A.prototype.Abs = _wrap_(function () {
        if (this.x < 0)
            this.x = -this.x;
        if (this.y < 0)
            this.y = -this.y;
    });
    A.prototype.Length = _wrap_(function () {
        return Math.sqrt(this.x * this.x + this.y * this.y);
    });
    A.prototype.LengthSquared = _wrap_(function () {
        return this.x * this.x + this.y * this.y;
    });
    A.prototype.Normalize = _wrap_(function () {
    ...
    A.prototype.IsValid = _wrap_(function () {
        return K.IsValid(this.x) && K.IsValid(this.y);
    });
    U.b2Vec3 = _wrap_(function () {
    });
    U.prototype.b2Vec3 = _wrap_(function (p, B, Q) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    U.prototype.SetZero = _wrap_(function () {
        this.x = this.y = this.z = 0;
    });
    U.prototype.Set = _wrap_(function (p, B, Q) {
        if (p === undefined)
            p = 0;
        if (B === undefined)
            B = 0;
    ...
    U.prototype.SetV = _wrap_(function (p) {
        this.x = p.x;
        this.y = p.y;
        this.z = p.z;
    });
    U.prototype.GetNegative = _wrap_(function () {
        return new U(-this.x, -this.y, -this.z);
    });
    U.prototype.NegativeSelf = _wrap_(function () {
        this.x = -this.x;
        this.y = -this.y;
        this.z = -this.z;
    });
    ...
    U.prototype.Add = _wrap_(function (p) {
        this.x += p.x;
        this.y += p.y;
        this.z += p.z;
    });
    U.prototype.Subtract = _wrap_(function (p) {
        this.x -= p.x;
        this.y -= p.y;
        this.z -= p.z;
    });
    U.prototype.Multiply = _wrap_(function (p) {
        if (p === undefined)
            p = 0;
        this.x *= p;
        this.y *= p;
...
_wrap_(function () {
    ...
    k.b2Body = _wrap_(function () {
        this.m_xf = new K();
        this.m_sweep = new G();
        this.m_linearVelocity = new y();
        this.m_force = new y();
    });
    k.prototype.connectEdges = _wrap_(function (a, c, g) {
        if (g === undefined)
            g = 0;
    ...
    k.prototype.CreateFixture = _wrap_(function (a) {
    ...
    k.prototype.CreateFixture2 = _wrap_(function (a, c) {
        if (c === undefined)
            c = 0;
        var g = new aa();
        g.shape = a;
    ...
    k.prototype.DestroyFixture = _wrap_(function (a) {
        if (this.m_world.IsLocked() != true) {
    ...
    k.prototype.SetPositionAndAngle = _wrap_(function (a, c) {
        if (c === undefined)
            c = 0;
        var g;
        if (this.m_world.IsLocked() != true) {
    ...
    k.prototype.SetTransform = _wrap_(function (a) {
        this.SetPositionAndAngle(a.position, a.GetAngle());
    });
    k.prototype.GetTransform = _wrap_(function () {
        return this.m_xf;
    });
    k.prototype.GetPosition = _wrap_(function () {
        return this.m_xf.position;
    });
    k.prototype.SetPosition = _wrap_(function (a) {
        this.SetPositionAndAngle(a, this.GetAngle());
    });
    k.prototype.GetAngle = _wrap_(function () {
        return this.m_sweep.a;
    });
    k.prototype.SetAngle = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        this.SetPositionAndAngle(this.GetPosition(), a);
    });
    k.prototype.GetWorldCenter = _wrap_(function () {
        return this.m_sweep.c;
    });
    k.prototype.GetLocalCenter = _wrap_(function () {
        return this.m_sweep.localCenter;
    });
    k.prototype.SetLinearVelocity = _wrap_(function (a) {
        this.m_type != k.b2_staticBody && this.m_linearVelocity.SetV(a);
    });
    k.prototype.GetLinearVelocity = _wrap_(function () {
        return this.m_linearVelocity;
    });
    k.prototype.SetAngularVelocity = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        if (this.m_type != k.b2_staticBody)
            this.m_angularVelocity = a;
    });
    k.prototype.GetAngularVelocity = _wrap_(function () {
        return this.m_angularVelocity;
    });
    k.prototype.GetDefinition = _wrap_(function () {
        var a = new z();
        a.type = this.GetType();
    ...
    k.prototype.ApplyForce = _wrap_(function (a, c) {
    ...
    k.prototype.ApplyTorque = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        if (this.m_type == k.b2_dynamicBody) {
            this.IsAwake() == false && this.SetAwake(true);
    ...
    k.prototype.ApplyImpulse = _wrap_(function (a, c) {
        if (this.m_type == k.b2_dynamicBody) {
            this.IsAwake() == false && this.SetAwake(true);
    ...
    k.prototype.Split = _wrap_(function (a) {
    ...
    k.prototype.Merge = _wrap_(function (a) {
        var c;
    ...
    k.prototype.GetMass = _wrap_(function () {
        return this.m_mass;
    });
    k.prototype.GetInertia = _wrap_(function () {
        return this.m_I;
    });
    k.prototype.GetMassData = _wrap_(function (a) {
        a.mass = this.m_mass;
        a.I = this.m_I;
        a.center.SetV(this.m_sweep.localCenter);
    });
    k.prototype.SetMassData = _wrap_(function (a) {
    ...
    k.prototype.ResetMassData = _wrap_(function () {
    ...
    k.prototype.GetWorldPoint = _wrap_(function (a) {
        var c = this.m_xf.R;
    ...
    k.prototype.GetWorldVector = _wrap_(function (a) {
        return F.MulMV(this.m_xf.R, a);
    });
    k.prototype.GetLocalPoint = _wrap_(function (a) {
        return F.MulXT(this.m_xf, a);
    });
    k.prototype.GetLocalVector = _wrap_(function (a) {
        return F.MulTMV(this.m_xf.R, a);
    });
    k.prototype.GetLinearVelocityFromWorldPoint = _wrap_(function (a) {
    ...
    k.prototype.GetLinearVelocityFromLocalPoint = _wrap_(function (a) {
        var c = this.m_xf.R;
        a = new y(c.col1.x * a.x + c.col2.x * a.y, c.col1.y * a.x + c.col2.y * a.y);
        a.x += this.m_xf.position.x;
        a.y += this.m_xf.position.y;
    ...
    k.prototype.GetLinearDamping = _wrap_(function () {
        return this.m_linearDamping;
    });
    k.prototype.SetLinearDamping = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        this.m_linearDamping = a;
    });
    k.prototype.GetAngularDamping = _wrap_(function () {
        return this.m_angularDamping;
    });
    k.prototype.SetAngularDamping = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        this.m_angularDamping = a;
    });
    k.prototype.SetType = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        if (this.m_type != a) {
            this.m_type = a;
    ...
    k.prototype.GetType = _wrap_(function () {
        return this.m_type;
    });
    k.prototype.SetBullet = _wrap_(function (a) {
        if (a)
            this.m_flags |= k.e_bulletFlag;
        else
            this.m_flags &= ~k.e_bulletFlag;
    });
    k.prototype.IsBullet = _wrap_(function () {
        return (this.m_flags & k.e_bulletFlag) == k.e_bulletFlag;
    });
    k.prototype.SetSleepingAllowed = _wrap_(function (a) {
        if (a)
    ...
    k.prototype.SetAwake = _wrap_(function (a) {
        if (a) {
    ...
    k.prototype.IsAwake = _wrap_(function () {
        return (this.m_flags & k.e_awakeFlag) == k.e_awakeFlag;
    });
    k.prototype.SetFixedRotation = _wrap_(function (a) {
        if (a)
    ...
    k.prototype.IsFixedRotation = _wrap_(function () {
        return (this.m_flags & k.e_fixedRotationFlag) == k.e_fixedRotationFlag;
    });
    k.prototype.SetActive = _wrap_(function (a) {
        if (a != this.IsActive()) {
            var c;
            if (a) {
    ...
    k.prototype.IsActive = _wrap_(function () {
        return (this.m_flags & k.e_activeFlag) == k.e_activeFlag;
    });
    k.prototype.IsSleepingAllowed = _wrap_(function () {
        return (this.m_flags & k.e_allowSleepFlag) == k.e_allowSleepFlag;
    });
    k.prototype.GetFixtureList = _wrap_(function () {
        return this.m_fixtureList;
    });
    k.prototype.GetJointList = _wrap_(function () {
        return this.m_jointList;
    });
    k.prototype.GetControllerList = _wrap_(function () {
        return this.m_controllerList;
    });
    k.prototype.GetContactList = _wrap_(function () {
        return this.m_contactList;
    });
    k.prototype.GetNext = _wrap_(function () {
        return this.m_next;
    });
    k.prototype.GetUserData = _wrap_(function () {
        return this.m_userData;
    });
    k.prototype.SetUserData = _wrap_(function (a) {
        this.m_userData = a;
    });
    k.prototype.GetWorld = _wrap_(function () {
        return this.m_world;
    });
    k.prototype.b2Body = _wrap_(function (a, c) {
        this.m_flags = 0;
        if (a.bullet)
            this.m_flags |= k.e_bulletFlag;
        if (a.fixedRotation)
    ...
    k.prototype.SynchronizeFixtures = _wrap_(function () {
        var a = k.s_xf1;
    ...
    k.prototype.SynchronizeTransform = _wrap_(function () {
    ...
    k.prototype.ShouldCollide = _wrap_(function (a) {
    ...
    k.prototype.Advance = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
    ...
    z.b2BodyDef = _wrap_(function () {
        this.position = new y();
        this.linearVelocity = new y();
    });
    z.prototype.b2BodyDef = _wrap_(function () {
        this.userData = null;
    ...
    u.b2ContactFilter = _wrap_(function () {
    });
    u.prototype.ShouldCollide = _wrap_(function (a, c) {
    ...
    u.prototype.RayCollide = _wrap_(function (a, c) {
        if (!a)
            return true;
    ...
    D.b2ContactImpulse = _wrap_(function () {
    ...
    H.b2ContactListener = _wrap_(function () {
    });
    H.prototype.BeginContact = _wrap_(function () {
    });
    H.prototype.EndContact = _wrap_(function () {
    });
    H.prototype.PreSolve = _wrap_(function () {
    });
    H.prototype.PostSolve = _wrap_(function () {
    });
    Box2D.postDefs.push(_wrap_(function () {
        Box2D.Dynamics.b2ContactListener.b2_defaultListener = new H();
    }));
    O.b2ContactManager = _wrap_(function () {
    });
    O.prototype.b2ContactManager = _wrap_(function () {
        this.m_world = null;
    ...
    O.prototype.AddPair = _wrap_(function (a, c) {
    ...
    O.prototype.FindNewContacts = _wrap_(function () {
        this.m_broadPhase.UpdatePairs(Box2D.generateCallback(this, this.AddPair));
    });
    O.prototype.Destroy = _wrap_(function (a) {
    ...
    O.prototype.Collide = _wrap_(function () {
    ...
    E.b2DebugDraw = _wrap_(function () {
    });
    E.prototype.b2DebugDraw = _wrap_(function () {
    });
    E.prototype.SetFlags = _wrap_(function () {
    });
    E.prototype.GetFlags = _wrap_(function () {
    });
    E.prototype.AppendFlags = _wrap_(function () {
    });
    E.prototype.ClearFlags = _wrap_(function () {
    });
    E.prototype.SetSprite = _wrap_(function () {
    });
    E.prototype.GetSprite = _wrap_(function () {
    });
    E.prototype.SetDrawScale = _wrap_(function () {
    });
    E.prototype.GetDrawScale = _wrap_(function () {
    });
    E.prototype.SetLineThickness = _wrap_(function () {
    });
    E.prototype.GetLineThickness = _wrap_(function () {
    });
    E.prototype.SetAlpha = _wrap_(function () {
    });
    E.prototype.GetAlpha = _wrap_(function () {
    });
    E.prototype.SetFillAlpha = _wrap_(function () {
    });
    E.prototype.GetFillAlpha = _wrap_(function () {
    });
    E.prototype.SetXFormScale = _wrap_(function () {
    });
    E.prototype.GetXFormScale = _wrap_(function () {
    });
    E.prototype.DrawPolygon = _wrap_(function () {
    });
    E.prototype.DrawSolidPolygon = _wrap_(function () {
    });
    E.prototype.DrawCircle = _wrap_(function () {
    });
    E.prototype.DrawSolidCircle = _wrap_(function () {
    });
    E.prototype.DrawSegment = _wrap_(function () {
    });
    E.prototype.DrawTransform = _wrap_(function () {
    });
    Box2D.postDefs.push(_wrap_(function () {
    ...
    R.b2DestructionListener = _wrap_(function () {
    });
    R.prototype.SayGoodbyeJoint = _wrap_(function () {
    });
    R.prototype.SayGoodbyeFixture = _wrap_(function () {
    });
    N.b2FilterData = _wrap_(function () {
        this.categoryBits = 1;
        this.maskBits = 65535;
        this.groupIndex = 0;
    });
    N.prototype.Copy = _wrap_(function () {
        var a = new N();
    ...
    S.b2Fixture = _wrap_(function () {
        this.m_filter = new N();
    });
    S.prototype.GetType = _wrap_(function () {
        return this.m_shape.GetType();
    });
    S.prototype.GetShape = _wrap_(function () {
        return this.m_shape;
    });
    S.prototype.SetSensor = _wrap_(function (a) {
    ...
    S.prototype.IsSensor = _wrap_(function () {
        return this.m_isSensor;
    });
    S.prototype.SetFilterData = _wrap_(function (a) {
    ...
    S.prototype.GetFilterData = _wrap_(function () {
        return this.m_filter.Copy();
    });
    S.prototype.GetBody = _wrap_(function () {
        return this.m_body;
    });
    S.prototype.GetNext = _wrap_(function () {
        return this.m_next;
    });
    S.prototype.GetUserData = _wrap_(function () {
        return this.m_userData;
    });
    S.prototype.SetUserData = _wrap_(function (a) {
        this.m_userData = a;
    });
    S.prototype.TestPoint = _wrap_(function (a) {
        return this.m_shape.TestPoint(this.m_body.GetTransform(), a);
    });
    S.prototype.RayCast = _wrap_(function (a, c) {
        return this.m_shape.RayCast(a, c, this.m_body.GetTransform());
    });
    S.prototype.GetMassData = _wrap_(function (a) {
        if (a === undefined)
            a = null;
        if (a == null)
            a = new I();
    ...
    S.prototype.SetDensity = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        this.m_density = a;
    });
    S.prototype.GetDensity = _wrap_(function () {
        return this.m_density;
    });
    S.prototype.GetFriction = _wrap_(function () {
        return this.m_friction;
    });
    S.prototype.SetFriction = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        this.m_friction = a;
    });
    S.prototype.GetRestitution = _wrap_(function () {
        return this.m_restitution;
    });
    S.prototype.SetRestitution = _wrap_(function (a) {
        if (a === undefined)
            a = 0;
        this.m_restitution = a;
    });
    S.prototype.GetAABB = _wrap_(function () {
        return this.m_aabb;
    });
    S.prototype.b2Fixture = _wrap_(function () {
        this.m_aabb = new U();
        this.m_shape = this.m_next = this.m_body = this.m_userData = null;
        this.m_restitution = this.m_friction = this.m_density = 0;
    });
    S.prototype.Create = _wrap_(function (a, c, g) {
    ...
    S.prototype.Destroy = _wrap_(function () {
        this.m_shape = null;
    });
    S.prototype.CreateProxy = _wrap_(function (a, c) {
        this.m_shape.ComputeAABB(this.m_aabb, c);
        this.m_proxy = a.CreateProxy(this.m_aabb, this);
    });
    S.prototype.DestroyProxy = _wrap_(function (a) {
        if (this.m_proxy != null) {
            a.DestroyProxy(this.m_proxy);
            this.m_proxy = null;
        }
    });
    S.prototype.Synchronize = _wrap_(function (a, c, g) {
        if (this.m_proxy) {
            var b = new U(), e = new U();
    ...
    aa.b2FixtureDef = _wrap_(function () {
        this.filter = new N();
    });
    aa.prototype.b2FixtureDef = _wrap_(function () {
    ...
    Z.b2Island = _wrap_(function () {
    });
    Z.prototype.b2Island = _wrap_(function () {
        this.m_bodies = new Vector();
        this.m_contacts = new Vector();
        this.m_joints = new Vector();
    });
    Z.prototype.Initialize = _wrap_(function (a, c, g, b, e, f) {
        if (a === undefined)
            a = 0;
        if (c === undefined)
            c = 0;
    ...
    Z.prototype.Clear = _wrap_(function () {
        this.m_jointCount = this.m_contactCount = this.m_bodyCount = 0;
    });
    Z.prototype.Solve = _wrap_(function (a, c, g) {
        var b = 0, e = 0, f;
    ...
    Z.prototype.SolveTOI = _wrap_(function (a) {
        var c = 0, g = 0;
        this.m_contactSolver.Initialize(a, this.m_contacts, this.m_contactCount, this.m_allocator);
    ...
    Z.prototype.Report = _wrap_(function (a) {
    ...
    Z.prototype.AddBody = _wrap_(function (a) {
        a.m_islandIndex = this.m_bodyCount;
        this.m_bodies[this.m_bodyCount++] = a;
    });
    Z.prototype.AddContact = _wrap_(function (a) {
        this.m_contacts[this.m_contactCount++] = a;
    });
    Z.prototype.AddJoint = _wrap_(function (a) {
        this.m_joints[this.m_jointCount++] = a;
    });
    Box2D.postDefs.push(_wrap_(function () {
        Box2D.Dynamics.b2Island.s_impulse = new D();
    }));
    d.b2TimeStep = _wrap_(function () {
    });
    d.prototype.Set = _wrap_(function (a) {
        this.dt = a.dt;
    ...
    h.b2World = _wrap_(function () {
        this.s_stack = new Vector();
        this.m_contactManager = new O();
        this.m_contactSolver = new o();
        this.m_island = new Z();
    });
    h.prototype.b2World = _wrap_(function (a, c) {
    ...
    h.prototype.SetDestructionListener = _wrap_(function (a) {
        this.m_destructionListener = a;
    });
    h.prototype.SetContactFilter = _wrap_(function (a) {
        this.m_contactManager.m_contactFilter = a;
    });
    h.prototype.SetContactListener = _wrap_(function (a) {
        this.m_contactManager.m_contactListener = a;
    });
    h.prototype.SetDebugDraw = _wrap_(function (a) {
        this.m_debugDraw = a;
    });
    h.prototype.SetBroadPhase = _wrap_(function (a) {
    ...
    h.prototype.Validate = _wrap_(function () {
        this.m_contactManager.m_broadPhase.Validate();
    });
    h.prototype.GetProxyCount = _wrap_(function () {
        return this.m_contactManager.m_broadPhase.GetProxyCount();
    });
    h.prototype.CreateBody = _wrap_(function (a) {
    ...
    h.prototype.DestroyBody = _wrap_(function (a) {
        if (this.IsLocked() != true) {
    ...
    h.prototype.CreateJoint = _wrap_(function (a) {
    ...
    h.prototype.DestroyJoint = _wrap_(function (a) {
    ...
    h.prototype.AddController = _wrap_(function (a) {
    ...
    h.prototype.RemoveController = _wrap_(function (a) {
        if (a.m_prev)
            a.m_prev.m_next = a.m_next;
        if (a.m_next)
            a.m_next.m_prev = a.m_prev;
    ...
    h.prototype.CreateController = _wrap_(function (a) {
        if (a.m_world != this)
    ...
    h.prototype.DestroyController = _wrap_(function (a) {
        a.Clear();
        if (a.m_next)
            a.m_next.m_prev = a.m_prev;
        if (a.m_prev)
    ...
    h.prototype.SetWarmStarting = _wrap_(function (a) {
        h.m_warmStarting = a;
    });
    h.prototype.SetContinuousPhysics = _wrap_(function (a) {
        h.m_continuousPhysics = a;
    });
    h.prototype.GetBodyCount = _wrap_(function () {
        return this.m_bodyCount;
    });
    h.prototype.GetJointCount = _wrap_(function () {
        return this.m_jointCount;
    });
    h.prototype.GetContactCount = _wrap_(function () {
        return this.m_contactCount;
    });
    h.prototype.SetGravity = _wrap_(function (a) {
        this.m_gravity = a;
    });
    h.prototype.GetGravity = _wrap_(function () {
        return this.m_gravity;
    });
    h.prototype.GetGroundBody = _wrap_(function () {
        return this.m_groundBody;
    });
    h.prototype.Step = _wrap_(function (a, c, g) {
        if (a === undefined)
            a = 0;
        if (c === undefined)
            c = 0;
    ...
    h.prototype.ClearForces = _wrap_(function () {
        for (var a = this.m_bodyList; a; a = a.m_next) {
            a.m_force.SetZero();
            a.m_torque = 0;
        }
    });
    h.prototype.DrawDebugData = _wrap_(function () {
    ...
    h.prototype.QueryAABB = _wrap_(function (a, c) {
        var g = this.m_contactManager.m_broadPhase;
        g.Query(_wrap_(function (b) {
            return a(g.GetUserData(b));
        }), c);
    });
    h.prototype.QueryShape = _wrap_(function (a, c, g) {
        if (g === undefined)
            g = null;
        if (g == null) {
            g = new K();
    ...
    h.prototype.QueryPoint = _wrap_(function (a, c) {
    ...
    h.prototype.RayCast = _wrap_(function (a, c, g) {
        var b = this.m_contactManager.m_broadPhase, e = new V(), f = new Q(c, g);
        b.RayCast(_wrap_(function (m, r) {
    ...
    h.prototype.RayCastOne = _wrap_(function (a, c) {
        var g;
        this.RayCast(_wrap_(function (b, e, f, m) {
            if (m === undefined)
                m = 0;
            g = b;
            return m;
    ...
    h.prototype.RayCastAll = _wrap_(function (a, c) {
        var g = new Vector();
        this.RayCast(_wrap_(function (b) {
            g[g.length] = b;
            return 1;
        }), a, c);
        return g;
    });
    h.prototype.GetBodyList = _wrap_(function () {
        return this.m_bodyList;
    });
    h.prototype.GetJointList = _wrap_(function () {
        return this.m_jointList;
    });
    h.prototype.GetContactList = _wrap_(function () {
        return this.m_contactList;
    });
    h.prototype.IsLocked = _wrap_(function () {
        return (this.m_flags & h.e_locked) > 0;
    });
    h.prototype.Solve = _wrap_(function (a) {
    ...
    h.prototype.SolveTOI = _wrap_(function (a) {
    ...
    h.prototype.DrawJoint = _wrap_(function (a) {
    ...
    h.prototype.DrawShape = _wrap_(function (a, c, g) {
        switch (a.m_type) {
...
_wrap_(function () {
    ...
    w.b2CircleContact = _wrap_(function () {
        Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments);
    });
    w.Create = _wrap_(function () {
        return new w();
    });
    w.Destroy = _wrap_(function () {
    });
    w.prototype.Reset = _wrap_(function (j, o) {
        this.__super.Reset.call(this, j, o);
    });
    w.prototype.Evaluate = _wrap_(function () {
    ...
    A.b2Contact = _wrap_(function () {
        this.m_nodeA = new B();
        this.m_nodeB = new B();
        this.m_manifold = new Z();
        this.m_oldManifold = new Z();
    });
    A.prototype.GetManifold = _wrap_(function () {
        return this.m_manifold;
    });
    A.prototype.GetWorldManifold = _wrap_(function (j) {
    ...
    A.prototype.IsTouching = _wrap_(function () {
        return (this.m_flags & A.e_touchingFlag) == A.e_touchingFlag;
    });
    A.prototype.IsContinuous = _wrap_(function () {
        return (this.m_flags & A.e_continuousFlag) == A.e_continuousFlag;
    });
    A.prototype.SetSensor = _wrap_(function (j) {
        if (j)
            this.m_flags |= A.e_sensorFlag;
        else
            this.m_flags &= ~A.e_sensorFlag;
    });
    A.prototype.IsSensor = _wrap_(function () {
        return (this.m_flags & A.e_sensorFlag) == A.e_sensorFlag;
    });
    A.prototype.SetEnabled = _wrap_(function (j) {
        if (j)
            this.m_flags |= A.e_enabledFlag;
        else
            this.m_flags &= ~A.e_enabledFlag;
    });
    A.prototype.IsEnabled = _wrap_(function () {
        return (this.m_flags & A.e_enabledFlag) == A.e_enabledFlag;
    });
    A.prototype.GetNext = _wrap_(function () {
        return this.m_next;
    });
    A.prototype.GetFixtureA = _wrap_(function () {
        return this.m_fixtureA;
    });
    A.prototype.GetFixtureB = _wrap_(function () {
        return this.m_fixtureB;
    });
    A.prototype.FlagForFiltering = _wrap_(function () {
        this.m_flags |= A.e_filterFlag;
    });
    A.prototype.b2Contact = _wrap_(function () {
    });
    A.prototype.Reset = _wrap_(function (j, o) {
        if (j === undefined)
            j = null;
        if (o === undefined)
            o = null;
    ...
    A.prototype.Update = _wrap_(function (j) {
    ...
    A.prototype.Evaluate = _wrap_(function () {
    });
    A.prototype.ComputeTOI = _wrap_(function (j, o) {
    ...
    U.b2ContactConstraint = _wrap_(function () {
    ...
    U.prototype.b2ContactConstraint = _wrap_(function () {
        this.points = new Vector(O.b2_maxManifoldPoints);
        for (var j = 0; j < O.b2_maxManifoldPoints; j++)
            this.points[j] = new p();
    });
    p.b2ContactConstraintPoint = _wrap_(function () {
        this.localPoint = new N();
        this.rA = new N();
        this.rB = new N();
    });
    B.b2ContactEdge = _wrap_(function () {
    });
    Q.b2ContactFactory = _wrap_(function () {
    });
    Q.prototype.b2ContactFactory = _wrap_(function (j) {
        this.m_allocator = j;
        this.InitializeRegisters();
    });
    Q.prototype.AddType = _wrap_(function (j, o, q, n) {
        if (q === undefined)
            q = 0;
        if (n === undefined)
            n = 0;
    ...
    Q.prototype.InitializeRegisters = _wrap_(function () {
    ...
    Q.prototype.Create = _wrap_(function (j, o) {
    ...
    Q.prototype.Destroy = _wrap_(function (j) {
    ...
    V.b2ContactRegister = _wrap_(function () {
    });
    M.b2ContactResult = _wrap_(function () {
        this.position = new N();
        this.normal = new N();
        this.id = new aa();
    });
    L.b2ContactSolver = _wrap_(function () {
        this.m_step = new H();
        this.m_constraints = new Vector();
    });
    L.prototype.b2ContactSolver = _wrap_(function () {
    });
    L.prototype.Initialize = _wrap_(function (j, o, q, n) {
        if (q === undefined)
            q = 0;
        var a;
        this.m_step.Set(j);
    ...
    L.prototype.InitVelocityConstraints = _wrap_(function (j) {
    ...
    L.prototype.SolveVelocityConstraints = _wrap_(function () {
    ...
    L.prototype.FinalizeVelocityConstraints = _wrap_(function () {
    ...
    L.prototype.SolvePositionConstraints = _wrap_(function (j) {
        if (j === undefined)
            j = 0;
    ...
    I.b2EdgeAndCircleContact = _wrap_(function () {
        Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments);
    });
    I.Create = _wrap_(function () {
        return new I();
    });
    I.Destroy = _wrap_(function () {
    });
    I.prototype.Reset = _wrap_(function (j, o) {
        this.__super.Reset.call(this, j, o);
    });
    I.prototype.Evaluate = _wrap_(function () {
        var j = this.m_fixtureA.GetBody(), o = this.m_fixtureB.GetBody();
    ...
    I.prototype.b2CollideEdgeAndCircle = _wrap_(function () {
    });
    Box2D.inherit(W, Box2D.Dynamics.Contacts.b2Contact);
    W.prototype.__super = Box2D.Dynamics.Contacts.b2Contact.prototype;
    W.b2NullContact = _wrap_(function () {
        Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments);
    });
    W.prototype.b2NullContact = _wrap_(function () {
    ...
    Y.b2PolyAndCircleContact = _wrap_(function () {
        Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments);
    });
    Y.Create = _wrap_(function () {
        return new Y();
    });
    Y.Destroy = _wrap_(function () {
    });
    Y.prototype.Reset = _wrap_(function (j, o) {
        this.__super.Reset.call(this, j, o);
        O.b2Assert(j.GetType() == y.e_polygonShape);
        O.b2Assert(o.GetType() == y.e_circleShape);
    });
    Y.prototype.Evaluate = _wrap_(function () {
    ...
    k.b2PolyAndEdgeContact = _wrap_(function () {
        Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments);
    });
    k.Create = _wrap_(function () {
        return new k();
    });
    k.Destroy = _wrap_(function () {
    });
    k.prototype.Reset = _wrap_(function (j, o) {
        this.__super.Reset.call(this, j, o);
        O.b2Assert(j.GetType() == y.e_polygonShape);
        O.b2Assert(o.GetType() == y.e_edgeShape);
    });
    k.prototype.Evaluate = _wrap_(function () {
        var j = this.m_fixtureA.GetBody(), o = this.m_fixtureB.GetBody();
    ...
    k.prototype.b2CollidePolyAndEdge = _wrap_(function () {
    });
    Box2D.inherit(z, Box2D.Dynamics.Contacts.b2Contact);
    z.prototype.__super = Box2D.Dynamics.Contacts.b2Contact.prototype;
    z.b2PolygonContact = _wrap_(function () {
        Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments);
    });
    z.Create = _wrap_(function () {
        return new z();
    });
    z.Destroy = _wrap_(function () {
    });
    z.prototype.Reset = _wrap_(function (j, o) {
        this.__super.Reset.call(this, j, o);
    });
    z.prototype.Evaluate = _wrap_(function () {
        var j = this.m_fixtureA.GetBody(), o = this.m_fixtureB.GetBody();
    ...
    u.b2PositionSolverManifold = _wrap_(function () {
    });
    u.prototype.b2PositionSolverManifold = _wrap_(function () {
        this.m_normal = new N();
    ...
    u.prototype.Initialize = _wrap_(function (j) {
...
_wrap_(function () {
    ...
    w.b2BuoyancyController = _wrap_(function () {
    ...
    w.prototype.Step = _wrap_(function () {
        if (this.m_bodyList) {
    ...
    w.prototype.Draw = _wrap_(function (M) {
        var L = new K(), I = new K();
    ...
    A.b2ConstantAccelController = _wrap_(function () {
        Box2D.Dynamics.Controllers.b2Controller.b2Controller.apply(this, arguments);
        this.A = new K(0, 0);
    });
    A.prototype.Step = _wrap_(function (M) {
    ...
    U.b2ConstantForceController = _wrap_(function () {
        Box2D.Dynamics.Controllers.b2Controller.b2Controller.apply(this, arguments);
        this.F = new K(0, 0);
    });
    U.prototype.Step = _wrap_(function () {
        for (var M = this.m_bodyList; M; M = M.nextBody) {
            var L = M.body;
            L.IsAwake() && L.ApplyForce(this.F, L.GetWorldCenter());
        }
    });
    p.b2Controller = _wrap_(function () {
    });
    p.prototype.Step = _wrap_(function () {
    });
    p.prototype.Draw = _wrap_(function () {
    });
    p.prototype.AddBody = _wrap_(function (M) {
        var L = new B();
        L.controller = this;
        L.body = M;
    ...
    p.prototype.RemoveBody = _wrap_(function (M) {
    ...
    p.prototype.Clear = _wrap_(function () {
        for (; this.m_bodyList;)
            this.RemoveBody(this.m_bodyList.body);
    });
    p.prototype.GetNext = _wrap_(function () {
        return this.m_next;
    });
    p.prototype.GetWorld = _wrap_(function () {
        return this.m_world;
    });
    p.prototype.GetBodyList = _wrap_(function () {
        return this.m_bodyList;
    });
    B.b2ControllerEdge = _wrap_(function () {
    });
    ...
    Q.b2GravityController = _wrap_(function () {
        Box2D.Dynamics.Controllers.b2Controller.b2Controller.apply(this, arguments);
        this.G = 1;
        this.invSqr = true;
    });
    Q.prototype.Step = _wrap_(function () {
    ...
    V.b2TensorDampingController = _wrap_(function () {
        Box2D.Dynamics.Controllers.b2Controller.b2Controller.apply(this, arguments);
        this.T = new F();
        this.maxTimestep = 0;
    });
    V.prototype.SetAxisAligned = _wrap_(function (M, L) {
        if (M === undefined)
            M = 0;
        if (L === undefined)
            L = 0;
    ...
    V.prototype.Step = _wrap_(function (M) {
        M = M.dt;
...
_wrap_(function () {
    ...
    U.b2DistanceJoint = _wrap_(function () {
        Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
        this.m_localAnchor1 = new w();
        this.m_localAnchor2 = new w();
        this.m_u = new w();
    });
    U.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchor1);
    });
    U.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchor2);
    });
    U.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return new w(d * this.m_impulse * this.m_u.x, d * this.m_impulse * this.m_u.y);
    });
    U.prototype.GetReactionTorque = _wrap_(function () {
        return 0;
    });
    U.prototype.GetLength = _wrap_(function () {
        return this.m_length;
    });
    U.prototype.SetLength = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_length = d;
    });
    U.prototype.GetFrequency = _wrap_(function () {
        return this.m_frequencyHz;
    });
    U.prototype.SetFrequency = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_frequencyHz = d;
    });
    U.prototype.GetDampingRatio = _wrap_(function () {
        return this.m_dampingRatio;
    });
    U.prototype.SetDampingRatio = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_dampingRatio = d;
    });
    U.prototype.b2DistanceJoint = _wrap_(function (d) {
    ...
    U.prototype.InitVelocityConstraints = _wrap_(function (d) {
    ...
    U.prototype.SolveVelocityConstraints = _wrap_(function () {
    ...
    U.prototype.SolvePositionConstraints = _wrap_(function () {
        var d;
        if (this.m_frequencyHz > 0)
            return true;
    ...
    p.b2DistanceJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
        this.localAnchorA = new w();
        this.localAnchorB = new w();
    });
    p.prototype.b2DistanceJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
        this.type = I.e_distanceJoint;
        this.length = 1;
        this.dampingRatio = this.frequencyHz = 0;
    });
    p.prototype.Initialize = _wrap_(function (d, h, l, j) {
        this.bodyA = d;
        this.bodyB = h;
    ...
    B.b2FrictionJoint = _wrap_(function () {
        Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
    ...
    B.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchorA);
    });
    B.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchorB);
    });
    B.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return new w(d * this.m_linearImpulse.x, d * this.m_linearImpulse.y);
    });
    B.prototype.GetReactionTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return d * this.m_angularImpulse;
    });
    B.prototype.SetMaxForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_maxForce = d;
    });
    B.prototype.GetMaxForce = _wrap_(function () {
        return this.m_maxForce;
    });
    B.prototype.SetMaxTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_maxTorque = d;
    });
    B.prototype.GetMaxTorque = _wrap_(function () {
        return this.m_maxTorque;
    });
    B.prototype.b2FrictionJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
    ...
    B.prototype.InitVelocityConstraints = _wrap_(function (d) {
        var h, l = 0, j = this.m_bodyA, o = this.m_bodyB;
        h = j.m_xf.R;
    ...
    B.prototype.SolveVelocityConstraints = _wrap_(function (d) {
    ...
    B.prototype.SolvePositionConstraints = _wrap_(function () {
        return true;
    });
    Box2D.inherit(Q, Box2D.Dynamics.Joints.b2JointDef);
    Q.prototype.__super = Box2D.Dynamics.Joints.b2JointDef.prototype;
    Q.b2FrictionJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
        this.localAnchorA = new w();
        this.localAnchorB = new w();
    });
    Q.prototype.b2FrictionJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
        this.type = I.e_frictionJoint;
        this.maxTorque = this.maxForce = 0;
    });
    Q.prototype.Initialize = _wrap_(function (d, h, l) {
        this.bodyA = d;
        this.bodyB = h;
        this.localAnchorA.SetV(this.bodyA.GetLocalPoint(l));
    ...
    V.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchor1);
    });
    V.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchor2);
    });
    V.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return new w(d * this.m_impulse * this.m_J.linearB.x, d * this.m_impulse * this.m_J.linearB.y);
    });
    V.prototype.GetReactionTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
    ...
    V.prototype.GetRatio = _wrap_(function () {
        return this.m_ratio;
    });
    V.prototype.SetRatio = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_ratio = d;
    });
    V.prototype.b2GearJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
    ...
    V.prototype.InitVelocityConstraints = _wrap_(function (d) {
    ...
    V.prototype.SolveVelocityConstraints = _wrap_(function () {
    ...
    V.prototype.SolvePositionConstraints = _wrap_(function () {
    ...
    M.b2GearJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
    });
    M.prototype.b2GearJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
        this.type = I.e_gearJoint;
        this.joint2 = this.joint1 = null;
        this.ratio = 1;
    });
    L.b2Jacobian = _wrap_(function () {
        this.linearA = new w();
        this.linearB = new w();
    });
    L.prototype.SetZero = _wrap_(function () {
        this.linearA.SetZero();
        this.angularA = 0;
        this.linearB.SetZero();
        this.angularB = 0;
    });
    L.prototype.Set = _wrap_(function (d, h, l, j) {
        if (h === undefined)
            h = 0;
        if (j === undefined)
            j = 0;
    ...
    L.prototype.Compute = _wrap_(function (d, h, l, j) {
        if (h === undefined)
            h = 0;
        if (j === undefined)
            j = 0;
    ...
    I.b2Joint = _wrap_(function () {
        this.m_edgeA = new Y();
        this.m_edgeB = new Y();
        this.m_localCenterA = new w();
        this.m_localCenterB = new w();
    });
    I.prototype.GetType = _wrap_(function () {
        return this.m_type;
    });
    I.prototype.GetAnchorA = _wrap_(function () {
        return null;
    });
    I.prototype.GetAnchorB = _wrap_(function () {
        return null;
    });
    I.prototype.GetReactionForce = _wrap_(function () {
        return null;
    });
    I.prototype.GetReactionTorque = _wrap_(function () {
        return 0;
    });
    I.prototype.GetBodyA = _wrap_(function () {
        return this.m_bodyA;
    });
    I.prototype.GetBodyB = _wrap_(function () {
        return this.m_bodyB;
    });
    I.prototype.GetNext = _wrap_(function () {
        return this.m_next;
    });
    I.prototype.GetUserData = _wrap_(function () {
        return this.m_userData;
    });
    I.prototype.SetUserData = _wrap_(function (d) {
        this.m_userData = d;
    });
    I.prototype.IsActive = _wrap_(function () {
        return this.m_bodyA.IsActive() && this.m_bodyB.IsActive();
    });
    I.Create = _wrap_(function (d) {
        var h = null;
        switch (d.type) {
    ...
    I.prototype.b2Joint = _wrap_(function (d) {
    ...
    I.prototype.InitVelocityConstraints = _wrap_(function () {
    });
    I.prototype.SolveVelocityConstraints = _wrap_(function () {
    });
    I.prototype.FinalizeVelocityConstraints = _wrap_(function () {
    });
    I.prototype.SolvePositionConstraints = _wrap_(function () {
        return false;
    });
    Box2D.postDefs.push(_wrap_(function () {
    ...
    k.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchor1);
    });
    k.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchor2);
    });
    k.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
    ...
    k.prototype.GetReactionTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return d * this.m_impulse.y;
    });
    k.prototype.GetJointTranslation = _wrap_(function () {
    ...
    k.prototype.GetJointSpeed = _wrap_(function () {
    ...
    k.prototype.IsLimitEnabled = _wrap_(function () {
        return this.m_enableLimit;
    });
    k.prototype.EnableLimit = _wrap_(function (d) {
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
        this.m_enableLimit = d;
    });
    k.prototype.GetLowerLimit = _wrap_(function () {
        return this.m_lowerTranslation;
    });
    k.prototype.GetUpperLimit = _wrap_(function () {
        return this.m_upperTranslation;
    });
    k.prototype.SetLimits = _wrap_(function (d, h) {
        if (d === undefined)
            d = 0;
        if (h === undefined)
            h = 0;
    ...
    k.prototype.IsMotorEnabled = _wrap_(function () {
        return this.m_enableMotor;
    });
    k.prototype.EnableMotor = _wrap_(function (d) {
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
        this.m_enableMotor = d;
    });
    k.prototype.SetMotorSpeed = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
    ...
    k.prototype.GetMotorSpeed = _wrap_(function () {
        return this.m_motorSpeed;
    });
    k.prototype.SetMaxMotorForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
    ...
    k.prototype.GetMaxMotorForce = _wrap_(function () {
        return this.m_maxMotorForce;
    });
    k.prototype.GetMotorForce = _wrap_(function () {
        return this.m_motorImpulse;
    });
    k.prototype.b2LineJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
        this.m_localAnchor1.SetV(d.localAnchorA);
        this.m_localAnchor2.SetV(d.localAnchorB);
    ...
    k.prototype.InitVelocityConstraints = _wrap_(function (d) {
    ...
    k.prototype.SolveVelocityConstraints = _wrap_(function (d) {
    ...
    k.prototype.SolvePositionConstraints = _wrap_(function () {
    ...
    z.b2LineJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
        this.localAnchorA = new w();
        this.localAnchorB = new w();
        this.localAxisA = new w();
    });
    z.prototype.b2LineJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
    ...
    z.prototype.Initialize = _wrap_(function (d, h, l, j) {
        this.bodyA = d;
        this.bodyB = h;
    ...
    Box2D.inherit(u, Box2D.Dynamics.Joints.b2Joint);
    u.prototype.__super = Box2D.Dynamics.Joints.b2Joint.prototype;
    u.b2MouseJoint = _wrap_(function () {
        Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
        this.K = new G();
        this.K1 = new G();
        this.K2 = new G();
    ...
    u.prototype.GetTarget = _wrap_(function () {
        return this.m_target;
    });
    u.prototype.SetTarget = _wrap_(function (d) {
        this.m_bodyB.IsAwake() == false && this.m_bodyB.SetAwake(true);
        this.m_target = d;
    });
    u.prototype.GetMaxForce = _wrap_(function () {
        return this.m_maxForce;
    });
    u.prototype.SetMaxForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_maxForce = d;
    });
    ...
    u.prototype.b2MouseJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
    ...
    u.prototype.SolveVelocityConstraints = _wrap_(function (d) {
    ...
    D.b2MouseJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
        this.target = new w();
    });
    D.prototype.b2MouseJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
    ...
    H.b2PrismaticJoint = _wrap_(function () {
        Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
        this.m_localAnchor1 = new w();
        this.m_localAnchor2 = new w();
        this.m_localXAxis1 = new w();
    ...
    H.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchor1);
    });
    H.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchor2);
    });
    H.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
    ...
    H.prototype.GetReactionTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return d * this.m_impulse.y;
    });
    H.prototype.GetJointTranslation = _wrap_(function () {
        var d = this.m_bodyA, h = this.m_bodyB, l = d.GetWorldPoint(this.m_localAnchor1), j = h.GetWorldPoint(this.m_localAnchor2);
        h = j.x - l.x;
        l = j.y - l.y;
        d = d.GetWorldVector(this.m_localXAxis1);
    ...
    H.prototype.GetJointSpeed = _wrap_(function () {
        var d = this.m_bodyA, h = this.m_bodyB, l;
        l = d.m_xf.R;
        var j = this.m_localAnchor1.x - d.m_sweep.localCenter.x, o = this.m_localAnchor1.y - d.m_sweep.localCenter.y, q = l.col1.x * j + l.col2.x * o;
        o = l.col1.y * j + l.col2.y * o;
    ...
    H.prototype.IsLimitEnabled = _wrap_(function () {
        return this.m_enableLimit;
    });
    H.prototype.EnableLimit = _wrap_(function (d) {
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
        this.m_enableLimit = d;
    });
    H.prototype.GetLowerLimit = _wrap_(function () {
        return this.m_lowerTranslation;
    });
    H.prototype.GetUpperLimit = _wrap_(function () {
        return this.m_upperTranslation;
    });
    H.prototype.SetLimits = _wrap_(function (d, h) {
        if (d === undefined)
            d = 0;
        if (h === undefined)
            h = 0;
    ...
    H.prototype.IsMotorEnabled = _wrap_(function () {
        return this.m_enableMotor;
    });
    H.prototype.EnableMotor = _wrap_(function (d) {
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
        this.m_enableMotor = d;
    });
    H.prototype.SetMotorSpeed = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
    ...
    H.prototype.GetMotorSpeed = _wrap_(function () {
        return this.m_motorSpeed;
    });
    H.prototype.SetMaxMotorForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
    ...
    H.prototype.GetMotorForce = _wrap_(function () {
        return this.m_motorImpulse;
    });
    H.prototype.b2PrismaticJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
        this.m_localAnchor1.SetV(d.localAnchorA);
        this.m_localAnchor2.SetV(d.localAnchorB);
        this.m_localXAxis1.SetV(d.localAxisA);
    ...
    H.prototype.InitVelocityConstraints = _wrap_(function (d) {
        var h = this.m_bodyA, l = this.m_bodyB, j, o = 0;
        this.m_localCenterA.SetV(h.GetLocalCenter());
        this.m_localCenterB.SetV(l.GetLocalCenter());
        var q = h.GetTransform();
    ...
    H.prototype.SolveVelocityConstraints = _wrap_(function (d) {
        var h = this.m_bodyA, l = this.m_bodyB, j = h.m_linearVelocity, o = h.m_angularVelocity, q = l.m_linearVelocity, n = l.m_angularVelocity, a = 0, c = 0, g = 0, b = 0;
        if (this.m_enableMotor && this.m_limitState != I.e_equalLimits) {
            b = this.m_motorMass * (this.m_motorSpeed - (this.m_axis.x * (q.x - j.x) + this.m_axis.y * (q.y - j.y) + this.m_a2 * n - this.m_a1 * o));
            a = this.m_motorImpulse;
    ...
    H.prototype.SolvePositionConstraints = _wrap_(function () {
    ...
    O.b2PrismaticJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
        this.localAnchorA = new w();
        this.localAnchorB = new w();
        this.localAxisA = new w();
    });
    O.prototype.b2PrismaticJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
    ...
    O.prototype.Initialize = _wrap_(function (d, h, l, j) {
        this.bodyA = d;
        this.bodyB = h;
        this.localAnchorA = this.bodyA.GetLocalPoint(l);
        this.localAnchorB = this.bodyB.GetLocalPoint(l);
    ...
    E.b2PulleyJoint = _wrap_(function () {
        Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
        this.m_groundAnchor1 = new w();
        this.m_groundAnchor2 = new w();
        this.m_localAnchor1 = new w();
    ...
    E.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchor1);
    });
    E.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchor2);
    });
    E.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return new w(d * this.m_impulse * this.m_u2.x, d * this.m_impulse * this.m_u2.y);
    });
    E.prototype.GetReactionTorque = _wrap_(function () {
        return 0;
    });
    E.prototype.GetGroundAnchorA = _wrap_(function () {
        var d = this.m_ground.m_xf.position.Copy();
        d.Add(this.m_groundAnchor1);
        return d;
    });
    E.prototype.GetGroundAnchorB = _wrap_(function () {
        var d = this.m_ground.m_xf.position.Copy();
        d.Add(this.m_groundAnchor2);
        return d;
    });
    E.prototype.GetLength1 = _wrap_(function () {
    ...
    E.prototype.GetLength2 = _wrap_(function () {
    ...
    E.prototype.GetRatio = _wrap_(function () {
        return this.m_ratio;
    });
    E.prototype.b2PulleyJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
    ...
    E.prototype.InitVelocityConstraints = _wrap_(function (d) {
    ...
    E.prototype.SolveVelocityConstraints = _wrap_(function () {
        var d = this.m_bodyA, h = this.m_bodyB, l;
        l = d.m_xf.R;
        var j = this.m_localAnchor1.x - d.m_sweep.localCenter.x, o = this.m_localAnchor1.y - d.m_sweep.localCenter.y, q = l.col1.x * j + l.col2.x * o;
        o = l.col1.y * j + l.col2.y * o;
    ...
    E.prototype.SolvePositionConstraints = _wrap_(function () {
    ...
    R.b2PulleyJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
    ...
    R.prototype.b2PulleyJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
    ...
    R.prototype.Initialize = _wrap_(function (d, h, l, j, o, q, n) {
        if (n === undefined)
            n = 0;
        this.bodyA = d;
        this.bodyB = h;
    ...
    N.b2RevoluteJoint = _wrap_(function () {
        Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
        this.K = new G();
        this.K1 = new G();
        this.K2 = new G();
    ...
    N.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchor1);
    });
    N.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchor2);
    });
    N.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return new w(d * this.m_impulse.x, d * this.m_impulse.y);
    });
    N.prototype.GetReactionTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return d * this.m_impulse.z;
    });
    N.prototype.GetJointAngle = _wrap_(function () {
        return this.m_bodyB.m_sweep.a - this.m_bodyA.m_sweep.a - this.m_referenceAngle;
    });
    N.prototype.GetJointSpeed = _wrap_(function () {
        return this.m_bodyB.m_angularVelocity - this.m_bodyA.m_angularVelocity;
    });
    N.prototype.IsLimitEnabled = _wrap_(function () {
        return this.m_enableLimit;
    });
    N.prototype.EnableLimit = _wrap_(function (d) {
        this.m_enableLimit = d;
    });
    N.prototype.GetLowerLimit = _wrap_(function () {
        return this.m_lowerAngle;
    });
    N.prototype.GetUpperLimit = _wrap_(function () {
        return this.m_upperAngle;
    });
    N.prototype.SetLimits = _wrap_(function (d, h) {
        if (d === undefined)
            d = 0;
        if (h === undefined)
            h = 0;
    ...
    N.prototype.IsMotorEnabled = _wrap_(function () {
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
        return this.m_enableMotor;
    });
    N.prototype.EnableMotor = _wrap_(function (d) {
        this.m_enableMotor = d;
    });
    N.prototype.SetMotorSpeed = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_bodyA.SetAwake(true);
        this.m_bodyB.SetAwake(true);
    ...
    N.prototype.GetMotorSpeed = _wrap_(function () {
        return this.m_motorSpeed;
    });
    N.prototype.SetMaxMotorTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        this.m_maxMotorTorque = d;
    });
    N.prototype.GetMotorTorque = _wrap_(function () {
        return this.m_maxMotorTorque;
    });
    N.prototype.b2RevoluteJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
        this.m_localAnchor1.SetV(d.localAnchorA);
        this.m_localAnchor2.SetV(d.localAnchorB);
    ...
    N.prototype.InitVelocityConstraints = _wrap_(function (d) {
        var h = this.m_bodyA, l = this.m_bodyB, j, o = 0;
        j = h.m_xf.R;
    ...
    N.prototype.SolveVelocityConstraints = _wrap_(function (d) {
    ...
    N.prototype.SolvePositionConstraints = _wrap_(function () {
    ...
    S.b2RevoluteJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
        this.localAnchorA = new w();
        this.localAnchorB = new w();
    });
    S.prototype.b2RevoluteJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
    ...
    S.prototype.Initialize = _wrap_(function (d, h, l) {
        this.bodyA = d;
        this.bodyB = h;
        this.localAnchorA = this.bodyA.GetLocalPoint(l);
        this.localAnchorB = this.bodyB.GetLocalPoint(l);
    ...
    aa.b2WeldJoint = _wrap_(function () {
        Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
        this.m_localAnchorA = new w();
        this.m_localAnchorB = new w();
        this.m_impulse = new A();
    ...
    aa.prototype.GetAnchorA = _wrap_(function () {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchorA);
    });
    aa.prototype.GetAnchorB = _wrap_(function () {
        return this.m_bodyB.GetWorldPoint(this.m_localAnchorB);
    });
    aa.prototype.GetReactionForce = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return new w(d * this.m_impulse.x, d * this.m_impulse.y);
    });
    aa.prototype.GetReactionTorque = _wrap_(function (d) {
        if (d === undefined)
            d = 0;
        return d * this.m_impulse.z;
    });
    aa.prototype.b2WeldJoint = _wrap_(function (d) {
        this.__super.b2Joint.call(this, d);
        this.m_localAnchorA.SetV(d.localAnchorA);
        this.m_localAnchorB.SetV(d.localAnchorB);
        this.m_referenceAngle = d.referenceAngle;
    ...
    aa.prototype.InitVelocityConstraints = _wrap_(function (d) {
        var h, l = 0, j = this.m_bodyA, o = this.m_bodyB;
        h = j.m_xf.R;
        var q = this.m_localAnchorA.x - j.m_sweep.localCenter.x, n = this.m_localAnchorA.y - j.m_sweep.localCenter.y;
        l = h.col1.x * q + h.col2.x * n;
    ...
    aa.prototype.SolveVelocityConstraints = _wrap_(function () {
    ...
    aa.prototype.SolvePositionConstraints = _wrap_(function () {
    ...
    Box2D.inherit(Z, Box2D.Dynamics.Joints.b2JointDef);
    Z.prototype.__super = Box2D.Dynamics.Joints.b2JointDef.prototype;
    Z.b2WeldJointDef = _wrap_(function () {
        Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
        this.localAnchorA = new w();
        this.localAnchorB = new w();
    });
    Z.prototype.b2WeldJointDef = _wrap_(function () {
        this.__super.b2JointDef.call(this);
        this.type = I.e_weldJoint;
        this.referenceAngle = 0;
    });
    Z.prototype.Initialize = _wrap_(function (d, h, l) {
        this.bodyA = d;
        this.bodyB = h;
        this.localAnchorA.SetV(this.bodyA.GetLocalPoint(l));
        this.localAnchorB.SetV(this.bodyB.GetLocalPoint(l));
...
_wrap_(function () {
    ...
    F.b2DebugDraw = _wrap_(function () {
        this.m_xformScale = this.m_fillAlpha = this.m_alpha = this.m_lineThickness = this.m_drawScale = 1;
        var G = this;
        this.m_sprite = {
            graphics: {
                clear: _wrap_(function () {
                    G.m_ctx.clearRect(0, 0, G.m_ctx.canvas.width, G.m_ctx.canvas.height);
                })
            }
        };
    });
    F.prototype._color = _wrap_(function (G, K) {
        return 'rgba(' + ((G & 16711680) >> 16) + ',' + ((G & 65280) >> 8) + ',' + (G & 255) + ',' + K + ')';
    });
    F.prototype.b2DebugDraw = _wrap_(function () {
        this.m_drawFlags = 0;
    });
    F.prototype.SetFlags = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_drawFlags = G;
    });
    F.prototype.GetFlags = _wrap_(function () {
        return this.m_drawFlags;
    });
    F.prototype.AppendFlags = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_drawFlags |= G;
    });
    F.prototype.ClearFlags = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_drawFlags &= ~G;
    });
    F.prototype.SetSprite = _wrap_(function (G) {
        this.m_ctx = G;
    });
    F.prototype.GetSprite = _wrap_(function () {
        return this.m_ctx;
    });
    F.prototype.SetDrawScale = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_drawScale = G;
    });
    F.prototype.GetDrawScale = _wrap_(function () {
        return this.m_drawScale;
    });
    F.prototype.SetLineThickness = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_lineThickness = G;
        this.m_ctx.strokeWidth = G;
    });
    F.prototype.GetLineThickness = _wrap_(function () {
        return this.m_lineThickness;
    });
    F.prototype.SetAlpha = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_alpha = G;
    });
    F.prototype.GetAlpha = _wrap_(function () {
        return this.m_alpha;
    });
    F.prototype.SetFillAlpha = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_fillAlpha = G;
    });
    F.prototype.GetFillAlpha = _wrap_(function () {
        return this.m_fillAlpha;
    });
    F.prototype.SetXFormScale = _wrap_(function (G) {
        if (G === undefined)
            G = 0;
        this.m_xformScale = G;
    });
    F.prototype.GetXFormScale = _wrap_(function () {
        return this.m_xformScale;
    });
    F.prototype.DrawPolygon = _wrap_(function (G, K, y) {
        if (K) {
    ...
    F.prototype.DrawSolidPolygon = _wrap_(function (G, K, y) {
        if (K) {
            var w = this.m_ctx, A = this.m_drawScale;
            w.beginPath();
            w.strokeStyle = this._color(y.color, this.m_alpha);
    ...
    F.prototype.DrawCircle = _wrap_(function (G, K, y) {
        if (K) {
            var w = this.m_ctx, A = this.m_drawScale;
            w.beginPath();
            w.strokeStyle = this._color(y.color, this.m_alpha);
    ...
    F.prototype.DrawSolidCircle = _wrap_(function (G, K, y, w) {
        if (K) {
    ...
    F.prototype.DrawSegment = _wrap_(function (G, K, y) {
        var w = this.m_ctx, A = this.m_drawScale;
        w.strokeStyle = this._color(y.color, this.m_alpha);
        w.beginPath();
    ...
    F.prototype.DrawTransform = _wrap_(function (G) {
