...
SplayTree.prototype.insert = _wrap_(function (key, value) {
    if (this.isEmpty()) {
...
SplayTree.prototype.remove = _wrap_(function (key) {
    if (this.isEmpty()) {
...
SplayTree.prototype.find = _wrap_(function (key) {
    if (this.isEmpty()) {
        return null;
    }
    this.splay_(key);
...
SplayTree.prototype.findMax = _wrap_(function (opt_startNode) {
    if (this.isEmpty()) {
        return null;
    }
...
SplayTree.prototype.findGreatestLessThan = _wrap_(function (key) {
    if (this.isEmpty()) {
        return null;
    }
    this.splay_(key);
...
SplayTree.prototype.exportKeys = _wrap_(function () {
    var result = [];
    if (!this.isEmpty()) {
        this.root_.traverse_(_wrap_(function (node) {
            result.push(node.key);
        }));
    }
    return result;
});
SplayTree.prototype.splay_ = _wrap_(function (key) {
    if (this.isEmpty()) {
        return;
    }
...
SplayTree.Node = _wrap_(function (key, value) {
    this.key = key;
    this.value = value;
});
SplayTree.Node.prototype.left = null;
SplayTree.Node.prototype.right = null;
SplayTree.Node.prototype.traverse_ = _wrap_(function (f) {
    var current = this;
    while (current) {
